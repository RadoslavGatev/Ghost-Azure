...
declare type UnknownMaybeWithToJson = unknown & {
    toJSON?: () => string;
};
/**
 ...
 */
export declare function walk(key: string, value: UnknownMaybeWithToJson, depth?: number, maxProperties?: number, memo?: MemoFunc): unknown;
export {};
