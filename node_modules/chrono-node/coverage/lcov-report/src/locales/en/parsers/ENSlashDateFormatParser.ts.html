...
<head>
    <title>Code coverage report for src/locales/en/parsers/ENSlashDateFormatParser.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/locales/en/parsers</a> ENSlashDateFormatParser.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        if (month &lt; 1 || month &gt; 12) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (month &gt; 12) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (day &gt;= 1 &amp;&amp; day &lt;= 12 &amp;&amp; month &lt;= 31) {
                    [day, month] = [month, day];
                } else {
...
&nbsp;
        if (match[YEAR_GROUP]) {
            const year = parseYear(match[YEAR_GROUP]) || <span class="branch-1 cbranch-no" title="branch not covered" >dayjs(context.refDate).year();</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat Jul 11 2020 20:37:01 GMT+0900 (Japan Standard Time)
            </div>
        </div>
