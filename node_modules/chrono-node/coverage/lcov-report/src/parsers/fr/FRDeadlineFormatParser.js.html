...
<head>
    <title>Code coverage report for src/parsers/fr/FRDeadlineFormatParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/parsers/fr</a> FRDeadlineFormatParser.js</h1>
        <div class='clearfix'>
...
<a name='L94'></a><a href='#L94'>94</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">60x</span>
...
&nbsp;
        ...
        if (util.INTEGER_WORDS[num] !== undefined) {
            ...
            num = 3;
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (num.match(/demi-?/i)) {
...
&nbsp;
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (match[4].match(/année/i)) {
...
&nbsp;
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (match[4].match(/secondes/i)) {
&nbsp;
