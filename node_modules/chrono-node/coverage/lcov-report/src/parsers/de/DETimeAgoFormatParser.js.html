...
<head>
    <title>Code coverage report for src/parsers/de/DETimeAgoFormatParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/parsers/de</a> DETimeAgoFormatParser.js</h1>
        <div class='clearfix'>
...
<a name='L108'></a><a href='#L108'>108</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">60x</span>
...
&nbsp;
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (/sekunde/i.test(match[3])) {
&nbsp;
