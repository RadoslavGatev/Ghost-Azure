...
<head>
    <title>Code coverage report for src/parsers/de/DECasualDateParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/parsers/de</a> DECasualDateParser.js</h1>
        <div class='clearfix'>
...
<a name='L97'></a><a href='#L97'>97</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">60x</span>
...
&nbsp;
        if (/(?:heute|diese)\s*nacht/.test(lowerText)) {
            ...
            startMoment = startMoment.add(refMoment.hour() &gt; 1 ? 2 : <span class="branch-1 cbranch-no" title="branch not covered" >1,</span> 'day');
        ...
        if (secondMatch) {
            switch (secondMatch.toLowerCase()) {
                ...
                case 'vormittag':
                    ...
                    break;
<span class="branch-2 cbranch-no" title="branch not covered" >                case 'mittag':</span>
