...
<head>
    <title>Code coverage report for src/parsers/nl/NLMonthNameLittleEndianParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/parsers/nl</a> NLMonthNameLittleEndianParser.js</h1>
        <div class='clearfix'>
...
<a name='L102'></a><a href='#L102'>102</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">60x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const parser = require('../parser');
...
&nbsp;
            if (/BE/i.test(year)) {
                ...
                year = parseInt(year);
                if (year &lt; 100){
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (year &gt; 50) {
                        year = year + 1900;
                    } else {
