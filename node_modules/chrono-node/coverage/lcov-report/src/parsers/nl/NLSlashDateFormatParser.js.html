...
<head>
    <title>Code coverage report for src/parsers/nl/NLSlashDateFormatParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/parsers/nl</a> NLSlashDateFormatParser.js</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(day &lt; 1 || day &gt; 31) <span class="cstat-no" title="statement not covered" >return null;</span>
&nbsp;
        if(year &lt; 100){
            <span class="missing-if-branch" title="if path not taken" >I</span>if (year &gt; 50) {
<span class="cstat-no" title="statement not covered" >                year = year + 1900;</span>
            } else {
                year = year + 2000;
            }
        }
