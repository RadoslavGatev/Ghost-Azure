...
<head>
    <title>Code coverage report for src/parsers/zh-Hant/ZHHantDateParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/parsers/zh-Hant</a> ZHHantDateParser.js</h1>
        <div class='clearfix'>
...
<a name='L68'></a><a href='#L68'>68</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">60x</span>
...
&nbsp;
        //Day
        <span class="missing-if-branch" title="else path not taken" >E</span>if (match[DAY_GROUP]) {
