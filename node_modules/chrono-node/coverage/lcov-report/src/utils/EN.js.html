...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> EN.js</h1>
        <div class='clearfix'>
...
<a name='L173'></a><a href='#L173'>173</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">60x</span>
...
&nbsp;
    if (match[2].match(/^h/i)) {
        ...
        fragments['month'] = num;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (match[2].match(/year/i)) {
        fragments['year'] = num;
    }
&nbsp;
    return fragments;
