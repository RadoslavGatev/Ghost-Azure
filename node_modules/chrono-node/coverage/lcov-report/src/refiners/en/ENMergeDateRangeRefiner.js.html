...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/refiners/en</a> ENMergeDateRangeRefiner.js</h1>
        <div class='clearfix'>
...
&nbsp;
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (toResult.isOnlyWeekday() &amp;&amp; toMoment.add(7, 'days').isAfter(fromMoment)) {
