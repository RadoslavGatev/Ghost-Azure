...
<head>
    <title>Code coverage report for src/refiners/en/ENPrioritizeSpecificDateRefiner.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/refiners/en</a> ENPrioritizeSpecificDateRefiner.js</h1>
        <div class='clearfix'>
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isMoreSpecific(prevResult, currResult)
                    &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >isAbleToMerge(text, prevResult, currResult))</span> {
&nbsp;
<span class="cstat-no" title="statement not covered" >                prevResult = mergeResult(text, prevResult, currResult);</span>
