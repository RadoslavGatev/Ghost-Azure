...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/refiners/en</a> ENMergeDateTimeRefiner.js</h1>
        <div class='clearfix'>
...
&nbsp;
    if (dateTimeComponent.get('meridiem') == 1 &amp;&amp; dateTimeComponent.get('hour') &lt; 12) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (timeComponent.isCertain('hour')) {
