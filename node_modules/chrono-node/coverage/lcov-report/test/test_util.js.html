...
<head>
    <title>Code coverage report for test/test_util.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">test</a> test_util.js</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        return {
            message: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >`Expected date to be: ${date} Received: ${actualDate}`,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return {</span>
            message: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >`Got ${results.length} results from '${text}'\n${</span>
                results.map(
<span class="fstat-no" title="function not covered" >                    re</span>sult =&gt; <span class="cstat-no" title="statement not covered" >JSON.stringify(result)</span>
                ).join('\n')
            }`,
            pass: false
        };
