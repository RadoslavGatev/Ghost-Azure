		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Chrono components for English support (<em>parsers</em>, <em>refiners</em>, and <em>configuration</em>)</p>
					</div>
				</div>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-variable tsd-parent-kind-namespace"><a href="en.html#gb" class="tsd-kind-icon">GB</a></li>
								<li class="tsd-kind-variable tsd-parent-kind-namespace"><a href="en.html#casual" class="tsd-kind-icon">casual</a></li>
								<li class="tsd-kind-variable tsd-parent-kind-namespace"><a href="en.html#strict" class="tsd-kind-icon">strict</a></li>
							</ul>
						</section>
						<section class="tsd-index-section ">
							<h3>Functions</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-function tsd-parent-kind-namespace"><a href="en.html#createcasualconfiguration" class="tsd-kind-icon">create<wbr>Casual<wbr>Configuration</a></li>
								<li class="tsd-kind-function tsd-parent-kind-namespace"><a href="en.html#createconfiguration" class="tsd-kind-icon">create<wbr>Configuration</a></li>
								<li class="tsd-kind-function tsd-parent-kind-namespace"><a href="en.html#parse" class="tsd-kind-icon">parse</a></li>
								<li class="tsd-kind-function tsd-parent-kind-namespace"><a href="en.html#parsedate" class="tsd-kind-icon">parse<wbr>Date</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-namespace">
					<a name="gb" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagConst">Const</span> GB</h3>
					<div class="tsd-signature tsd-kind-icon">GB<span class="tsd-signature-symbol">:</span> <a href="../classes/chrono.html" class="tsd-signature-type" data-tsd-kind="Class">Chrono</a><span class="tsd-signature-symbol"> = ...</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/wanasit/chrono/blob/59d06db/src/locales/en/index.ts#L43">locales/en/index.ts:43</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>Chrono object configured for parsing <em>UK-style</em> English</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-namespace">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/wanasit/chrono/blob/59d06db/src/locales/en/index.ts#L33">locales/en/index.ts:33</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>Chrono object configured for parsing <em>casual</em> English</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-namespace">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/wanasit/chrono/blob/59d06db/src/locales/en/index.ts#L38">locales/en/index.ts:38</a></li>
						</ul>
					</aside>
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>Chrono object configured for parsing <em>strict</em> English</p>
						</div>
					</div>
				</section>
			</section>
				...
				<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/wanasit/chrono/blob/59d06db/src/locales/en/index.ts#L63">locales/en/index.ts:63</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Create a default <em>casual</em> {@Link Configuration} for English chrono.
									It calls <a href="en.html#createconfiguration">createConfiguration</a> and includes additional parsers.</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								<li>
									<h5>littleEndian: <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> = false</span></h5>
								</li>
							</ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/wanasit/chrono/blob/59d06db/src/locales/en/index.ts#L79">locales/en/index.ts:79</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Create a default {@Link Configuration} for English chrono</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								<li>
									...
									<div class="tsd-comment tsd-typography">
										<p>If the timeunit mentioning should be strict, not casual</p>
									</div>
								</li>
								<li>
									<h5>littleEndian: <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> = false</span></h5>
									<div class="tsd-comment tsd-typography">
										<p>If format should be date-first/littleEndian (e.g. en_UK), not month-first/middleEndian (e.g. en_US)</p>
									</div>
								</li>
							</ul>
							<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Configuration</span></h4>
				...
				<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/wanasit/chrono/blob/59d06db/src/locales/en/index.ts#L48">locales/en/index.ts:48</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>A shortcut for en.casual.parse()</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
				...
				<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/wanasit/chrono/blob/59d06db/src/locales/en/index.ts#L55">locales/en/index.ts:55</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>A shortcut for en.casual.parseDate()</p>
								</div>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				<ul class="before-current">
					<li class=" tsd-kind-variable tsd-parent-kind-namespace">
						<a href="en.html#gb" class="tsd-kind-icon">GB</a>
					</li>
					<li class=" tsd-kind-variable tsd-parent-kind-namespace">
						<a href="en.html#casual" class="tsd-kind-icon">casual</a>
					</li>
					<li class=" tsd-kind-variable tsd-parent-kind-namespace">
						<a href="en.html#strict" class="tsd-kind-icon">strict</a>
					</li>
					<li class=" tsd-kind-function tsd-parent-kind-namespace">
						<a href="en.html#createcasualconfiguration" class="tsd-kind-icon">create<wbr>Casual<wbr>Configuration</a>
					</li>
					<li class=" tsd-kind-function tsd-parent-kind-namespace">
						<a href="en.html#createconfiguration" class="tsd-kind-icon">create<wbr>Configuration</a>
					</li>
					<li class=" tsd-kind-function tsd-parent-kind-namespace">
						<a href="en.html#parse" class="tsd-kind-icon">parse</a>
					</li>
					<li class=" tsd-kind-function tsd-parent-kind-namespace">
						<a href="en.html#parsedate" class="tsd-kind-icon">parse<wbr>Date</a>
					</li>
				</ul>
			</nav>
		</div>
