import { disabledUntil, eventStatusFromHttpCode, isRateLimited, makePromiseBuffer, rejectedSyncPromise, resolvedSyncPromise, serializeEnvelope, updateRateLimits, } from '@sentry/utils';
...
export function createTransport(options, makeRequest, buffer) {
    ...
    function send(envelope, category) {
        var request = {
            category: category,
