...
var ContextLines = /** @class */ (function () {
    ...
    ContextLines.prototype.addSourceContext = function (event, contextLines) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        if (!(contextLines > 0 && ((_a = event.exception) === null || _a === void 0 ? void 0 : _a.values))) return [3 /*break*/, 8];
                        _f.label = 1;
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._addSourceContextToFrames(exception.stacktrace.frames, contextLines)];
                    case 3:
                        _f.sent();
                        _f.label = 4;
                    case 4:
    ...
    ContextLines.prototype._addSourceContextToFrames = function (frames, contextLines) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var frames_1, frames_1_1, frame, sourceFile, lines, e_2_1;
            var e_2, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!!frames_1_1.done) return [3 /*break*/, 4];
                        frame = frames_1_1.value;
                        if (!frame.filename) return [3 /*break*/, 3];
