...
addEventListener("visibilitychange",n,!0),addEventListener("pagehide",n,!0)},_=-1,y=function(){return _<0&&(_="hidden"===Object(s.a)().document.visibilityState?0:1/0,b((function(t){var e=t.timeStamp
_=e}),!0)),{get firstHiddenTime(){return _}}},O={},T=Object(s.a)(),j={_reportAllChanges:!1},S=function(){function t(t){var e,n
...
if(T&&T.performance&&T.performance.getEntries&&m.b){r.b.log("[Tracing] Adding & adjusting spans using Performance API")
...
"first-paint"===u.name&&f&&(r.b.log("[Measurements] Adding FP"),e._measurements.fp={value:u.startTime},e._measurements["mark.fp"]={value:m}),"first-contentful-paint"===u.name&&f&&(r.b.log("[Measurements] Adding FCP"),e._measurements.fcp={value:u.startTime},e._measurements["mark.fcp"]={value:m})
break
...
"number"==typeof s&&(r.b.log("[Measurements] Adding TTFB"),this._measurements.ttfb={value:1e3*(s-t.startTimestamp)},"number"==typeof o&&o<=s&&(this._measurements["ttfb.requestTime"]={value:1e3*(s-o)})),["fcp","fp","lcp"].forEach((function(n){if(e._measurements[n]&&!(p>=t.startTimestamp)){var i=e._measurements[n].value,a=p+Object(d.e)(i),s=Math.abs(1e3*(a-t.startTimestamp)),o=s-i
r.b.log("[Measurements] Normalized "+n+" from "+i+" to "+s+" ("+o+")"),e._measurements[n].value=s}})),this._measurements["mark.fid"]&&this._measurements.fid&&x(t,{description:"first input delay",endTimestamp:this._measurements["mark.fid"].value+Object(d.e)(this._measurements.fid.value),op:"web.vitals",startTimestamp:this._measurements["mark.fid"].value}),"fcp"in this._measurements||delete this._measurements.cls,t.setMeasurements(this._measurements),this._tagMetricInfo(t)}}},t.prototype._tagMetricInfo=function(t){this._lcpEntry&&(r.b.log("[Measurements] Adding LCP Data"),this._lcpEntry.element&&t.setTag("lcp.element",Object(h.b)(this._lcpEntry.element)),this._lcpEntry.id&&t.setTag("lcp.id",this._lcpEntry.id),this._lcpEntry.url&&t.setTag("lcp.url",this._lcpEntry.url.trim().slice(0,200)),t.setTag("lcp.size",this._lcpEntry.size)),this._clsEntry&&this._clsEntry.sources&&(r.b.log("[Measurements] Adding CLS Data"),this._clsEntry.sources.forEach((function(e,n){return t.setTag("cls.source."+(n+1),Object(h.b)(e.node))})))},t.prototype._trackCLS=function(){var t=this
...
o&&(n=f(t,i,void 0),b((function(){o.takeRecords().map(s),n(!0)})))}((function(e){var n=e.entries.pop()
n&&(r.b.log("[Measurements] Adding CLS"),t._measurements.cls={value:e.value},t._clsEntry=n)}))},t.prototype._trackNavigator=function(t){var e=T.navigator
...
if(s){n=f(t,a,e)
var o=function(){O[a.id]||(s.takeRecords().map(r),s.disconnect(),O[a.id]=!0,n(!0))};["keydown","click"].forEach((function(t){addEventListener(t,o,{once:!0,capture:!0})})),b(o,!0)}}((function(t){var n=t.entries.pop()
if(n){var i=Object(d.e)(m.b),a=Object(d.e)(n.startTime)
r.b.log("[Measurements] Adding LCP"),e._measurements.lcp={value:t.value},e._measurements["mark.lcp"]={value:i+a},e._lcpEntry=n}}),t)},t.prototype._trackFID=function(){var t=this
...
s&&(n=f(t,a,void 0),b((function(){s.takeRecords().map(r),s.disconnect()}),!0))}((function(e){var n=e.entries.pop()
if(n){var i=Object(d.e)(m.b),a=Object(d.e)(n.startTime)
...
this._getCurrentHub=e,this._emitOptionsWarning&&(r.b.warn("[Tracing] You need to define `tracingOrigins` in the options. Set an array of urls or patterns to trace."),r.b.warn("[Tracing] We added a reasonable default for you: "+R.tracingOrigins))
...
!1===f.sampled&&r.b.log("[Tracing] Will not send "+f.op+" transaction because of beforeNavigate."),r.b.log("[Tracing] Starting "+f.op+" transaction on scope")
var v=this._getCurrentHub(),g=Object(s.a)().location,b=Object(o.b)(v,f,c,!0,{location:g})
...
n&&(i>t||i<0)&&(e.setStatus(u.a.DeadlineExceeded),e.setTag("maxTransactionDurationExceeded","true"))}(Object(d.f)(p),t,n)})),b}r.b.warn("[Tracing] Did not create "+t.op+" transaction because _getCurrentHub is invalid.")},t.id="BrowserTracing",t}(),q=function(){function t(e){void 0===e&&(e={}),this.name=t.id,this._router=e.router||e.app,this._methods=(Array.isArray(e.methods)?e.methods:[]).concat("use")}return t.prototype.setupOnce=function(){this._router?function(t,e){void 0===e&&(e=[]),e.forEach((function(e){return function(t,e){var n=t[e]
return t[e]=function(){for(var t=[],i=0;i<arguments.length;i++)t[i]=arguments[i]
return n.call.apply(n,Object(a.e)([this],F(t,e)))},t}(t,e)}))}(this._router,this._methods):r.b.error("ExpressIntegration is missing an Express instance")},t.id="Express",t}()
...
return null===(e=c)||void 0===e||e.finish(),t})):(null===(o=c)||void 0===o||o.finish(),u)}}))}else r.b.error("Postgres Integration was unable to access 'pg-native' bindings.")
else r.b.error("Postgres Integration was unable to require `pg` package.")},t.id="Postgres",t}(),z=function(){function t(){this.name=t.id}return t.prototype.setupOnce=function(t,e){var n=Object(l.c)("mysql/lib/Connection.js")
...
t.endTimestamp||(t.endTimestamp=e,t.setStatus(o.a.Cancelled),r.b.log("[Tracing] cancelling span since transaction ended early",JSON.stringify(t,void 0,2)))
