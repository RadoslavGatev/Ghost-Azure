...
null!=r.from&&r.from==r.to&&!1!==r.marker.clearWhenEmpty&&e.splice(t--,1)}return e.length?e:null}function ze(e){var t=e.markedSpans
if(t){for(var r=0;r<t.length;++r)t[r].marker.detachLine(e)
e.markedSpans=null}}function De(e,t){if(t){for(var r=0;r<t.length;++r)t[r].marker.attachLine(e)
...
return n}var At={}
function Ot(e,t){E(t,At.hasOwnProperty(e)?At[e]:At[e]={})}function Wt(e,t){if(!0===t)return t
if(e.copyState)return e.copyState(t)
var r={}
for(var n in t){var i=t[n]
i instanceof Array&&(i=i.concat([])),r[n]=i}return r}function zt(e,t){for(var r;e.innerMode&&(r=e.innerMode(t))&&r.mode!=e;)t=r.state,e=r.mode
return r||{mode:e,state:t}}function Dt(e,t,r){return!e.startState||e.startState(t,r)}var Pt=function(e,t,r){this.pos=this.start=0,this.string=e,this.tabSize=t||8,this.lastColumnPos=this.lastColumnValue=0,this.lineStart=0,this.lineOracle=r}
...
return{styles:i,classes:o.bgClass||o.textClass?o:null}}function Ft(e,t,r){if(!t.styles||t.styles[0]!=e.state.modeGen){var n=Rt(e,fe(t)),i=t.text.length>e.options.maxHighlightLength&&Wt(e.doc.mode,n.state),o=Et(e,t,n)
...
var c=F(s.text,null,e.options.tabSize);(null==i||n>c)&&(i=l-1,n=c)}return i}(e,t,r),a=o>n.first&&se(n,o-1).stateAfter,l=a?It.fromSaved(n,a,o):new It(n,Dt(n.mode),o)
...
if(e.innerMode){var r=zt(e,t)
return r.mode.blankLine?r.mode.blankLine(r.state):void 0}}function Vt(e,t,r,n){for(var i=0;i<10;i++){n&&(n[0]=zt(e,r).mode)
var o=e.token(t,r)
...
for(n&&(o=[]);(n||c.pos<t.ch)&&!c.eol();)c.start=c.pos,i=Vt(l,c,u.state),n&&o.push(new Kt(c,i,Wt(a.mode,u.state)))
...
i(p,c),u=p}}var $t=function(e,t,r){this.text=e,De(this,t),this.height=r?r(this):1}
function _t(e){e.parent=null,ze(e)}$t.prototype.lineNo=function(){return fe(this)},st($t)
var Xt={},Yt={}
...
for(var i=0;i<e.rest.length;i++)if(fe(e.rest[i])>r)return{map:e.measure.maps[i],cache:e.measure.caches[i],before:!0}}function Or(e,t,r,n){return Dr(e,zr(e,t),r,n)}function Wr(e,t){if(t>=e.display.viewFrom&&t<e.display.viewTo)return e.display.view[un(e,t)]
var r=e.display.externalMeasured
return r&&t>=r.lineN&&t<r.lineN+r.size?r:void 0}function zr(e,t){var r=fe(t),n=Wr(e,r)
...
return{left:n-a.left,top:i-a.top}}function qr(e,t,r,n,i){return n||(n=se(e.doc,t.line)),Gr(e,n,Or(e,n,t.ch,i),r)}function $r(e,t,r,n,i,o){function a(t,a){var l=Dr(e,i,t,a?"right":"left",o)
return a?l.left=l.right:l.right=l.left,Gr(e,n,l,r)}n=n||se(e.doc,t.line),i||(i=zr(e,n))
...
return{begin:o,end:i=ae(function(t){return Dr(e,r,t).top>n},o,i)}}function Qr(e,t,r,n){return r||(r=zr(e,t)),Zr(e,t,r,Gr(e,t,Dr(e,r,n),"line").top)}function Jr(e,t,r,n){return!(e.bottom<=r)&&(e.top>r||(n?e.left:e.right)>t)}function en(e,t,r,n,i){i-=$e(t)
var o=zr(e,t),a=Kr(t),l=0,s=t.text.length,u=!0,c=Je(t,e.doc.direction)
...
var r=!0
t.cursorDiv.style.visibility="",e.options.cursorBlinkRate>0?t.blinker=setInterval(function(){return t.cursorDiv.style.visibility=(r=!r)?"":"hidden"},e.options.cursorBlinkRate):e.options.cursorBlinkRate<0&&(t.cursorDiv.style.visibility="hidden")}}function mn(e){e.state.focused||(e.display.input.focus(),yn(e))}function vn(e){e.state.delayingBlurEvent=!0,setTimeout(function(){e.state.delayingBlurEvent&&(e.state.delayingBlurEvent=!1,bn(e))},100)}function yn(e,t){e.state.delayingBlurEvent&&(e.state.delayingBlurEvent=!1),"nocursor"!=e.options.readOnly&&(e.state.focused||(it(e,"focus",e,t),e.state.focused=!0,D(e.display.wrapper,"CodeMirror-focused"),e.curOp||e.display.selForContextMenu==e.doc.sel||(e.display.input.reset(),s&&setTimeout(function(){return e.display.input.reset(!0)},20)),e.display.input.receivedFocus()),gn(e))}function bn(e,t){e.state.delayingBlurEvent||(e.state.focused&&(it(e,"blur",e,t),e.state.focused=!1,T(e.display.wrapper,"CodeMirror-focused")),clearInterval(e.display.blinker),setTimeout(function(){e.state.focused||(e.display.shift=!1)},150))}function wn(e){for(var t=e.display,r=t.lineDiv.offsetTop,n=0;n<t.view.length;n++){var i=t.view[n],o=e.options.lineWrapping,s=void 0,u=0
...
if(s<2&&(s=tn(t)),(f>.005||f<-.005)&&(de(i.line,s),xn(i.line),i.rest))for(var h=0;h<i.rest.length;h++)xn(i.rest[h])
...
function Bn(e){e.display.scrollbars&&(e.display.scrollbars.clear(),e.display.scrollbars.addClass&&T(e.display.wrapper,e.display.scrollbars.addClass)),e.display.scrollbars=new Rn[e.options.scrollbarStyle](function(t){e.display.wrapper.insertBefore(t,e.display.scrollbarFiller),tt(t,"mousedown",function(){e.state.focused&&setTimeout(function(){return e.display.input.focus()},0)}),t.setAttribute("cm-not-content","true")},function(t,r){"horizontal"==r?Dn(e,t):Wn(e,t)},e),e.display.scrollbars.addClass&&D(e.display.wrapper,e.display.scrollbars.addClass)}var jn=0
function Vn(e){var t
...
e.updatedDisplay&&li(t,e.update),null==r.wheelStartX||null==e.scrollTop&&null==e.scrollLeft&&!e.scrollToPos||(r.wheelStartX=r.wheelStartY=null),null!=e.scrollTop&&zn(t,e.scrollTop,e.forceScroll),null!=e.scrollLeft&&Dn(t,e.scrollLeft,!0,!0),e.scrollToPos&&function(e,t){if(!ot(e,"scrollCursorIntoView")){var r=e.display,n=r.sizer.getBoundingClientRect(),i=null
...
if(null!=u.scrollTop&&(Wn(e,u.scrollTop),Math.abs(e.doc.scrollTop-c)>1&&(a=!0)),null!=u.scrollLeft&&(Dn(e,u.scrollLeft),Math.abs(e.doc.scrollLeft-d)>1&&(a=!0)),!a)break}return i}(t,Ce(n,e.scrollToPos.from),Ce(n,e.scrollToPos.to),e.scrollToPos.margin))
...
t.iter(n.line,Math.min(t.first+t.size,e.display.viewTo+500),function(o){if(n.line>=e.display.viewFrom){var a=o.styles,l=o.text.length>e.options.maxHighlightLength?Wt(t.mode,n.state):null,s=Et(e,o,n,!0)
...
break e}if(i&&!r&&!d&&null!=pi)return o&&c&&Wn(e,Math.max(0,l.scrollTop+o*pi)),Dn(e,Math.max(0,l.scrollLeft+i*pi)),(!o||o&&c)&&ut(t),void(a.wheelStartX=null)
...
r&&!s||(t(l.doc,s),e(l.doc,n,s))}}}(e,null,!0)}function Wi(e,t){if(t.cm)throw new Error("This document is already in use.")
e.doc=t,t.cm=e,ln(e),Ti(e),zi(e),e.options.lineWrapping||Xe(e),e.options.mode=t.modeOption,Qn(e)}function zi(e){("rtl"==e.doc.direction?D:T)(e.display.lineDiv,"CodeMirror-rtl")}function Di(e){this.done=[],this.undone=[],this.undoDepth=1/0,this.lastModTime=this.lastSelTime=0,this.lastOp=this.lastSelOp=null,this.lastOrigin=this.lastSelOrigin=null,this.generation=this.maxGeneration=e||1}function Pi(e,t){var r={from:be(t.from),to:ki(t),text:ue(e,t.from,t.to)}
...
t&&n&&_n(n,function(){var i=t.line,o=fe(t.line),a=Wr(n,o)
...
var o=me(r,0)
this.sel=xi(o),this.history=new Di(null),this.id=++Lo,this.modeOption=t,this.lineSep=n,this.direction="rtl"==i?"rtl":"ltr",this.extend=!1,"string"==typeof e&&(e=this.splitLines(e)),Ai(this,{from:o,to:o,text:e}),_i(this,xi(o),K)}
...
return{undo:t,redo:r}},clearHistory:function(){this.history=new Di(this.history.maxGeneration)},markClean:function(){this.cleanGeneration=this.changeGeneration(!0)},changeGeneration:function(e){return e&&(this.history.lastOp=this.history.lastSelOp=this.history.lastOrigin=null),this.history.generation},isClean:function(e){return this.history.generation==(e||this.cleanGeneration)},getHistory:function(){return{done:ji(this.history.done),undone:ji(this.history.undone)}},setHistory:function(e){var t=this.history=new Di(this.history.maxGeneration)
...
Oi(e,function(e){return r.push(e.id)},!0),e.history=new Di(null),e.history.done=ji(this.history.done,r),e.history.undone=ji(this.history.undone,r)}},iterLinkedDocs:function(e){Oi(this,e)},getMode:function(){return this.mode},getEditor:function(){return this.cm},splitLines:function(e){return this.lineSep?e.split(this.lineSep):xt(e)},lineSeparator:function(){return this.lineSep||"\n"},setDirection:Zn(function(e){var t
"rtl"!=e&&(e="ltr"),e!=this.direction&&(this.direction=e,this.iter(function(e){return e.order=null}),this.cm&&_n(t=this.cm,function(){zi(t),Qn(t)}))})}),To.prototype.eachLine=To.prototype.iter
var Mo=0
...
t.cachedCharWidth=t.cachedTextHeight=t.cachedPaddingH=null,t.scrollbarsClipped=!1,e.setSize()}for(var Do={3:"Pause",8:"Backspace",9:"Tab",13:"Enter",16:"Shift",17:"Ctrl",18:"Alt",19:"Pause",20:"CapsLock",27:"Esc",32:"Space",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"Left",38:"Up",39:"Right",40:"Down",44:"PrintScrn",45:"Insert",46:"Delete",59:";",61:"=",91:"Mod",92:"Mod",93:"Mod",106:"*",107:"=",109:"-",110:".",111:"/",127:"Delete",145:"ScrollLock",173:"-",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'",63232:"Up",63233:"Down",63234:"Left",63235:"Right",63272:"Delete",63273:"Home",63275:"End",63276:"PageUp",63277:"PageDown",63302:"Insert"},Po=0;Po<10;Po++)Do[Po+48]=Do[Po+96]=String(Po)
for(var Ho=65;Ho<=90;Ho++)Do[Ho]=String.fromCharCode(Ho)
for(var Io=1;Io<=12;Io++)Do[Io+111]=Do[Io+63235]="F"+Io
var Eo={}
...
if(a)return a}}}function jo(e){var t="string"==typeof e?e:Do[e.keyCode]
...
if(l.level>0||"rtl"==t.doc.direction){var u=zr(t,r)
a=i<0?r.text.length-1:0
var c=Dr(t,u,a).top
a=ae(function(e){return Dr(t,u,e).top==c},i<0==(1==l.level)?l.from:l.to-1,a),"before"==s&&(a=qo(r,a,1))}else a=i<0?l.to:l.from
...
if(t.curOp.focus=z(),!ot(t,e)){a&&l<11&&27==e.keyCode&&(e.returnValue=!1)
var r=e.keyCode
...
function r(e){18!=e.keyCode&&e.altKey||(T(t,"CodeMirror-crosshair"),nt(document,"keyup",r),nt(document,"mouseover",r))}D(t,"CodeMirror-crosshair"),tt(document,"keyup",r),tt(document,"mouseover",r)}(t)}}function oa(e){16==e.keyCode&&(this.doc.sel.shift=!1),ot(this,e)}function aa(e){var t=this
...
var n=!1
try{e.isReadOnly()&&(e.state.suppressEdits=!0),n=t(e,r)!=V}finally{e.state.suppressEdits=!1}return n})}(t,i,n,o,e)||(1==i?n?function(e,t,r,n){a?setTimeout(I(mn,e),0):e.curOp.focus=z()
...
if(l)if(0!=ve(l,d)){e.curOp.focus=z(),f(l)
...
Wo||(tt(window,"resize",function(){null==e&&(e=setTimeout(function(){e=null,Oo(zo)},100))}),tt(window,"blur",function(){return Oo(bn)}),Wo=!0)}(),Vn(this),this.curOp.forceUpdate=!0,Wi(this,n),t.autofocus&&!v||this.hasFocus()?setTimeout(I(yn,this),20):bn(this),va)va.hasOwnProperty(u)&&va[u](r,t[u],ga)
...
var a=e.state.pasteIncoming||"paste"==i,l=xt(t),s=null
if(a&&n.ranges.length>1)if(Sa&&Sa.text.join("\n")==t){if(n.ranges.length%Sa.text.length==0){s=[]
for(var u=0;u<Sa.text.length;u++)s.push(o.splitLines(Sa.text[u]))}}else l.length==n.ranges.length&&e.options.pasteLinesPerSelection&&(s=Y(l,function(e){return[e]}))
for(var c=e.curOp.updateInput,d=n.ranges.length-1;d>=0;d--){var f=n.ranges[d],h=f.from(),p=f.to()
f.empty()&&(r&&r>0?h=me(h.line,h.ch-r):e.state.overwrite&&!a?p=me(p.line,Math.min(se(o,p.line).text.length,p.ch+X(l).length)):a&&Sa&&Sa.lineWise&&Sa.text.join("\n")==t&&(h=p=me(h.line,0)))
var g={from:h,to:p,text:s?s[d%s.length]:l,origin:i||(a?"paste":e.state.cutIncoming?"cut":"+input")}
io(e.doc,g),sr(e,"inputRead",e,g)}t&&!a&&Na(e,t),Mn(e),e.curOp.updateInput<2&&(e.curOp.updateInput=c),e.curOp.typing=!0,e.state.pasteIncoming=e.state.cutIncoming=!1}function Ma(e,t){var r=e.clipboardData&&e.clipboardData.getData("Text")
...
r.push(o),t.push(e.getRange(o.anchor,o.head))}return{text:t,ranges:r}}function Oa(e,t){e.setAttribute("autocorrect","off"),e.setAttribute("autocapitalize","off"),e.setAttribute("spellcheck",!!t)}function Wa(){var e=A("textarea",null,null,"position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none"),t=A("div",[e],null,"overflow: hidden; position: relative; width: 3px; height: 0px;")
return s?e.style.width="1000px":e.setAttribute("wrap","off"),g&&(e.style.border="1px solid black"),Oa(e),t}function za(e,t,r,n,i){var o=t,a=r,l=se(e,t.line)
...
var l,s=function(e,r){return qo(t,e instanceof me?e.ch:e,r)},u=function(r){return e.options.lineWrapping?(l=l||zr(e,t),Qr(e,t,l,r)):{begin:0,end:t.text.length}},c=u("before"==r.sticky?s(r,-1):r.ch)
...
return ye(o,g)&&(g.hitSide=!0),g}function Da(e,t,r,n){var i,o,a=e.doc,l=t.left
...
function Ha(e,t){var r=Wr(e,t.line)
...
if(!t||!W(n,t))return Ia(me(fe(e.line),0),!0)
...
r.composing&&r.composing.range.clear(),r.composing={start:e,range:n.markText(e,n.getCursor("to"),{className:"CodeMirror-composing"})}}),tt(i,"compositionend",function(){r.composing&&(r.poll(),r.composing.range.clear(),r.composing=null)})},Ra.prototype.createField=function(e){this.wrapper=Wa(),this.textarea=this.wrapper.firstChild},Ra.prototype.prepareSelection=function(){var e=this.cm,t=e.display,r=e.doc,n=dn(e)
...
this.textarea.value=r,t.state.focused&&H(this.textarea),a&&l>=9&&(this.hasSelection=r)}else e||(this.prevInput=this.textarea.value="",a&&l>=9&&(this.hasSelection=null))}},Ra.prototype.getField=function(){return this.textarea},Ra.prototype.supportsTouch=function(){return!1},Ra.prototype.focus=function(){if("nocursor"!=this.cm.options.readOnly&&(!v||z()!=this.textarea))try{this.textarea.focus()}catch(e){}},Ra.prototype.blur=function(){this.textarea.blur()},Ra.prototype.resetPosition=function(){this.wrapper.style.top=this.wrapper.style.left=0},Ra.prototype.receivedFocus=function(){this.slowPoll()},Ra.prototype.slowPoll=function(){var e=this
...
if(null==o?o=s.left:s.left=o,(a=Da(this,s,i,r)).hitSide)break}return a},moveV:Yn(function(e,t){var r=this,n=this.doc,i=[],o=!this.display.shift&&!n.extend&&n.sel.somethingSelected()
...
for(;n<t.length&&a(t.charAt(n));)++n}return new bi(me(e.line,r),me(e.line,n))},toggleOverwrite:function(e){null!=e&&e==this.state.overwrite||((this.state.overwrite=!this.state.overwrite)?D(this.display.cursorDiv,"CodeMirror-overwrite"):T(this.display.cursorDiv,"CodeMirror-overwrite"),it(this,"overwriteToggle",this,this.state.overwrite))},hasFocus:function(){return this.display.input.getField()==z()},isReadOnly:function(){return!(!this.options.readOnly&&!this.doc.cantEdit)},scrollTo:Yn(function(e,t){Nn(this,e,t)}),getScrollInfo:function(){var e=this.display.scroller
...
return t.cm=null,Wi(this,e),Br(this),this.display.input.reset(),Nn(this,e.scrollLeft,e.scrollTop),this.curOp.forceScroll=!0,sr(this,"swapDoc",this,t),t}),phrase:function(e){var t=this.options.phrases
...
return l},function(e){e.off=nt,e.on=tt,e.wheelEventPixels=mi,e.Doc=To,e.splitLines=xt,e.countColumn=F,e.findColumn=q,e.isWordChar=ee,e.Pass=V,e.signal=it,e.Line=$t,e.changeEnd=ki,e.scrollbarModel=Rn,e.Pos=me,e.cmpPos=ve,e.modes=Lt,e.mimeModes=Tt,e.resolveMode=Mt,e.getMode=Nt,e.modeExtensions=At,e.extendMode=Ot,e.copyState=Wt,e.startState=Dt,e.innerMode=zt,e.commands=Xo,e.keyMap=Eo,e.keyName=Ko,e.isModifierKey=jo,e.lookupKey=Bo,e.normalizeKeyMap=Ro,e.StringStream=Pt,e.SharedTextMarker=ko,e.TextMarker=wo,e.LineWidget=vo,e.e_preventDefault=ut,e.e_stopPropagation=ct,e.e_stop=ft,e.addClass=D,e.contains=W,e.rmClass=T,e.keyNames=Do}(xa),xa.version="5.42.2",xa}),function(e){"object"==typeof exports&&"object"==typeof module?e(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],e):e(CodeMirror)}(function(e){"use strict"
...
function z(){C.state.context=new A(C.state.context,C.state.localVars,!1),C.state.localVars=W}function D(){C.state.context=new A(C.state.context,C.state.localVars,!0),C.state.localVars=null}function P(){C.state.localVars=C.state.context.vars,C.state.context=C.state.context.prev}function H(e,t){var r=function(){var r=C.state,n=r.indented
...
e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function E(e){return function t(r){return r==e?L():";"==e||"}"==r||")"==r||"]"==r?S():L(t)}}function F(e,t){return"var"==e?L(H("vardef",t),ye,E(";"),I):"keyword a"==e?L(H("form"),V,F,I):"keyword b"==e?L(H("form"),F,I):"keyword d"==e?C.stream.match(/^\s*$/,!1)?L():L(H("stat"),G,E(";"),I):"debugger"==e?L(E(";")):"{"==e?L(H("}"),D,ae,I,P):";"==e?L():"if"==e?("else"==C.state.lexical.info&&C.state.cc[C.state.cc.length-1]==I&&C.state.cc.pop()(),L(H("form"),V,F,I,Se)):"function"==e?L(Oe):"for"==e?L(H("form"),Le,F,I):"class"==e||u&&"interface"==t?(C.marked="keyword",L(H("form"),De,I)):"variable"==e?u&&"declare"==t?(C.marked="keyword",L(F)):u&&("module"==t||"enum"==t||"type"==t)&&C.stream.match(/^\s*\w/,!1)?(C.marked="keyword","enum"==t?L(Ue):"type"==t?L(ce,E("operator"),ce,E(";")):L(H("form"),be,E("{"),H("}"),ae,I,I)):u&&"namespace"==t?(C.marked="keyword",L(H("form"),B,ae,I)):u&&"abstract"==t?(C.marked="keyword",L(F)):L(H("stat"),J):"switch"==e?L(H("form"),V,E("{"),H("}","switch"),D,ae,I,I,P):"case"==e?L(B,E(":")):"default"==e?L(E(":")):"catch"==e?L(H("form"),z,R,F,I,P):"export"==e?L(H("stat"),Ee,I):"import"==e?L(H("stat"),Re,I):"async"==e?L(F):"@"==t?L(B,F):S(H("stat"),B,E(";"),I)}function R(e){if("("==e)return L(We,E(")"))}function B(e,t){return K(e,t,!1)}function j(e,t){return K(e,t,!0)}function V(e){return"("!=e?S():L(H(")"),B,E(")"),I)}function K(e,t,r){if(C.state.fatArrowAt==C.stream.start){var n=r?Y:X
if("("==e)return L(z,H(")"),ie(We,")"),I,E("=>"),n,P)
if("variable"==e)return S(z,be,E("=>"),n,P)}var i=r?q:U
return w.hasOwnProperty(e)?L(i):"function"==e?L(Oe,i):"class"==e||u&&"interface"==t?(C.marked="keyword",L(H("form"),ze,I)):"keyword c"==e||"async"==e?L(r?j:B):"("==e?L(H(")"),G,E(")"),I,i):"operator"==e||"spread"==e?L(r?j:B):"["==e?L(H("]"),Ge,I,i):"{"==e?oe(te,"}",null,i):"quasi"==e?S($,i):"new"==e?L(function(e){return function(t){return"."==t?L(e?Q:Z):"variable"==t&&u?L(ge,e?q:U):S(e?j:B)}}(r)):"import"==e?L(B):L()}function G(e){return e.match(/[;\}\)\],]/)?S():S(B)}function U(e,t){return","==e?L(B):q(e,t,!1)}function q(e,t,r){var n=0==r?U:q,i=0==r?B:j
return"=>"==e?L(z,r?Y:X,P):"operator"==e?/\+\+|--/.test(t)||u&&"!"==t?L(n):u&&"<"==t&&C.stream.match(/^([^>]|<.*?>)*>\s*\(/,!1)?L(H(">"),ie(ce,">"),I,n):"?"==t?L(B,E(":"),i):L(i):"quasi"==e?S($,n):";"!=e?"("==e?oe(j,")","call",n):"."==e?L(ee,n):"["==e?L(H("]"),G,E("]"),I,n):u&&"as"==t?(C.marked="keyword",L(ce,n)):"regexp"==e?(C.state.lastType=C.marked="operator",C.stream.backUp(C.stream.pos-C.stream.start-1),L(i)):void 0:void 0}function $(e,t){return"quasi"!=e?S():"${"!=t.slice(t.length-2)?L($):L(B,_)}function _(e){if("}"==e)return C.marked="string-2",C.state.tokenize=v,L($)}function X(e){return b(C.stream,C.state),S("{"==e?F:B)}function Y(e){return b(C.stream,C.state),S("{"==e?F:j)}function Z(e,t){if("target"==t)return C.marked="keyword",L(U)}function Q(e,t){if("target"==t)return C.marked="keyword",L(q)}function J(e){return":"==e?L(I,F):S(U,E(";"),I)}function ee(e){if("variable"==e)return C.marked="property",L()}function te(e,t){return"async"==e?(C.marked="property",L(te)):"variable"==e||"keyword"==C.style?(C.marked="property","get"==t||"set"==t?L(re):(u&&C.state.fatArrowAt==C.stream.start&&(r=C.stream.match(/^\s*:\s*/,!1))&&(C.state.fatArrowAt=C.stream.pos+r[0].length),L(ne))):"number"==e||"string"==e?(C.marked=l?"property":C.style+" property",L(ne)):"jsonld-keyword"==e?L(ne):u&&N(t)?(C.marked="keyword",L(te)):"["==e?L(B,le,E("]"),ne):"spread"==e?L(j,ne):"*"==t?(C.marked="keyword",L(te)):":"==e?S(ne):void 0
var r}function re(e){return"variable"!=e?S(ne):(C.marked="property",L(Oe))}function ne(e){return":"==e?L(j):"("==e?S(Oe):void 0}function ie(e,t,r){function n(i,o){if(r?r.indexOf(i)>-1:","==i){var a=C.state.lexical
return"call"==a.info&&(a.pos=(a.pos||0)+1),L(function(r,n){return r==t||n==t?S():S(e)},n)}return i==t||o==t?L():L(E(t))}return function(r,i){return r==t||i==t?L():S(e,n)}}function oe(e,t,r){for(var n=3;n<arguments.length;n++)C.cc.push(arguments[n])
return L(H(t,r),ie(e,t),I)}function ae(e){return"}"==e?L():S(F,ae)}function le(e,t){if(u){if(":"==e)return L(ce)
if("?"==t)return L(le)}}function se(e){if(u&&":"==e)return C.stream.match(/^\s*\w+\s+is\b/,!1)?L(B,ue,ce):L(ce)}function ue(e,t){if("is"==t)return C.marked="keyword",L()}function ce(e,t){return"keyof"==t||"typeof"==t?(C.marked="keyword",L("keyof"==t?ce:j)):"variable"==e||"void"==t?(C.marked="type",L(pe)):"string"==e||"number"==e||"atom"==e?L(pe):"["==e?L(H("]"),ie(ce,"]",","),I,pe):"{"==e?L(H("}"),ie(fe,"}",",;"),I,pe):"("==e?L(ie(he,")"),de):"<"==e?L(ie(ce,">"),ce):void 0}function de(e){if("=>"==e)return L(ce)}function fe(e,t){return"variable"==e||"keyword"==C.style?(C.marked="property",L(fe)):"?"==t?L(fe):":"==e?L(ce):"["==e?L(B,le,E("]"),fe):void 0}function he(e,t){return"variable"==e&&C.stream.match(/^\s*[?:]/,!1)||"?"==t?L(he):":"==e?L(ce):S(ce)}function pe(e,t){return"<"==t?L(H(">"),ie(ce,">"),I,pe):"|"==t||"."==e||"&"==t?L(ce):"["==e?L(E("]"),pe):"extends"==t||"implements"==t?(C.marked="keyword",L(ce)):void 0}function ge(e,t){if("<"==t)return L(H(">"),ie(ce,">"),I,pe)}function me(){return S(ce,ve)}function ve(e,t){if("="==t)return L(ce)}function ye(e,t){return"enum"==t?(C.marked="keyword",L(Ue)):S(be,le,ke,Ce)}function be(e,t){return u&&N(t)?(C.marked="keyword",L(be)):"variable"==e?(M(t),L()):"spread"==e?L(be):"["==e?oe(xe,"]"):"{"==e?oe(we,"}"):void 0}function we(e,t){return"variable"!=e||C.stream.match(/^\s*:/,!1)?("variable"==e&&(C.marked="property"),"spread"==e?L(be):"}"==e?S():"["==e?L(B,E("]"),E(":"),we):L(E(":"),be,ke)):(M(t),L(ke))}function xe(){return S(be,ke)}function ke(e,t){if("="==t)return L(j)}function Ce(e){if(","==e)return L(ye)}function Se(e,t){if("keyword b"==e&&"else"==t)return L(H("form","else"),F,I)}function Le(e,t){return"await"==t?L(Le):"("==e?L(H(")"),Te,E(")"),I):void 0}function Te(e){return"var"==e?L(ye,E(";"),Ne):";"==e?L(Ne):"variable"==e?L(Me):S(B,E(";"),Ne)}function Me(e,t){return"in"==t||"of"==t?(C.marked="keyword",L(B)):L(U,Ne)}function Ne(e,t){return";"==e?L(Ae):"in"==t||"of"==t?(C.marked="keyword",L(B)):S(B,E(";"),Ae)}function Ae(e){")"!=e&&L(B)}function Oe(e,t){return"*"==t?(C.marked="keyword",L(Oe)):"variable"==e?(M(t),L(Oe)):"("==e?L(z,H(")"),ie(We,")"),I,se,F,P):u&&"<"==t?L(H(">"),ie(me,">"),I,Oe):void 0}function We(e,t){return"@"==t&&L(B,We),"spread"==e?L(We):u&&N(t)?(C.marked="keyword",L(We)):S(be,le,ke)}function ze(e,t){return"variable"==e?De(e,t):Pe(e,t)}function De(e,t){if("variable"==e)return M(t),L(Pe)}function Pe(e,t){return"<"==t?L(H(">"),ie(me,">"),I,Pe):"extends"==t||"implements"==t||u&&","==e?("implements"==t&&(C.marked="keyword"),L(u?ce:B,Pe)):"{"==e?L(H("}"),He,I):void 0}function He(e,t){return"async"==e||"variable"==e&&("static"==t||"get"==t||"set"==t||u&&N(t))&&C.stream.match(/^\s+[\w$\xa1-\uffff]/,!1)?(C.marked="keyword",L(He)):"variable"==e||"keyword"==C.style?(C.marked="property",L(u?Ie:Oe,He)):"["==e?L(B,le,E("]"),u?Ie:Oe,He):"*"==t?(C.marked="keyword",L(He)):";"==e?L(He):"}"==e?L():"@"==t?L(B,He):void 0}function Ie(e,t){return"?"==t?L(Ie):":"==e?L(ce,ke):"="==t?L(j):S(Oe)}function Ee(e,t){return"*"==t?(C.marked="keyword",L(Ke,E(";"))):"default"==t?(C.marked="keyword",L(B,E(";"))):"{"==e?L(ie(Fe,"}"),Ke,E(";")):S(F)}function Fe(e,t){return"as"==t?(C.marked="keyword",L(E("variable"))):"variable"==e?S(j,Fe):void 0}function Re(e){return"string"==e?L():"("==e?S(B):S(Be,je,Ke)}function Be(e,t){return"{"==e?oe(Be,"}"):("variable"==e&&M(t),"*"==t&&(C.marked="keyword"),L(Ve))}function je(e){if(","==e)return L(Be,je)}function Ve(e,t){if("as"==t)return C.marked="keyword",L(Be)}function Ke(e,t){if("from"==t)return C.marked="keyword",L(B)}function Ge(e){return"]"==e?L():S(ie(j,"]"))}function Ue(){return S(H("form"),be,E("{"),H("}"),ie(qe,"}"),I,I)}function qe(){return S(be,ke)}function $e(e,t,r){return t.tokenize==g&&/^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)||"quasi"==t.lastType&&/\{\s*$/.test(e.string.slice(0,e.pos-(r||0)))}return P.lex=!0,I.lex=!0,{startState:function(e){var t={tokenize:g,lastType:"sof",cc:[],lexical:new x((e||0)-o,0,"block",!1),localVars:r.localVars,context:r.localVars&&new A(null,null,!1),indented:e||0}
