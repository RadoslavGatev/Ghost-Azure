...
f=w.left,v=i<w.top||i>=w.bottom}return $r(r,m=oe(t.text,m,1),h,v,n-f)}function en(e){if(null!=e.cachedTextHeight)return e.cachedTextHeight
if(null==zr){zr=A("pre")
