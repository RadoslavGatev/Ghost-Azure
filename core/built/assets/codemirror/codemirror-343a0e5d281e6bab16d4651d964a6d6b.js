...
if(i+=o-n,i+=r-i%r,n=o+1,i>=t)return n}}function p(e){for(;go.length<=e;)go.push(g(go)+" ")
return go[e]}function g(e){return e[e.length-1]}function m(e,t){for(var r=[],n=0;n<e.length;n++)r[n]=t(e[n],n)
return r}function v(){}function y(e,t){var r
return Object.create?r=Object.create(e):(v.prototype=e,r=new v),t&&c(t,r),r}function b(e){return/\w/.test(e)||e>""&&(e.toUpperCase()!=e.toLowerCase()||mo.test(e))}function w(e,t){return t?!!(t.source.indexOf("\\w")>-1&&b(e))||t.test(e):b(e)}function x(e){for(var t in e)if(e.hasOwnProperty(t)&&e[t])return!1
return!0}function k(e){return e.charCodeAt(0)>=768&&vo.test(e)}function C(e,t,r){for(;(r<0?t>0:t<e.length)&&k(e.charAt(t));)t+=r
...
if(o)return-o
return P(n.to,i.to)||Y(e)-Y(t)||t.id-e.id}function Q(e,t){var r,n=bo&&e.markedSpans
if(n)for(var i=void 0,o=0;o<n.length;++o)(i=n[o]).marker.collapsed&&null==(t?i.from:i.to)&&(!r||Z(r,i.marker)<0)&&(r=i.marker)
return r}function J(e){return Q(e,!0)}function ee(e){return Q(e,!1)}function te(e,t,r,n,i){var o=L(e,t),a=bo&&o.markedSpans
...
return A(n)+1}function oe(e,t){var r=bo&&t.markedSpans
...
o.to==t&&(o.from!=o.to&&"before"==r?n=i:wo=i),o.from==t&&(o.from!=o.to&&"before"!=r?n=i:wo=i)}return null!=n?n:wo}function de(e,t){var r=e.order
return null==r&&(r=e.order=xo(e.text,t)),r}function fe(e,t){return e._handlers&&e._handlers[t]||ko}function he(e,t,r){if(e.removeEventListener)e.removeEventListener(t,r,!1)
...
if(t)for(var r=e.curOp.cursorActivityHandlers||(e.curOp.cursorActivityHandlers=[]),n=0;n<t.length;++n)-1==f(r,t[n])&&r.push(t[n])}function ve(e,t){return fe(e,t).length>0}function ye(e){e.prototype.on=function(e,t){Co(this,e,t)},e.prototype.off=function(e,t){he(this,e,t)}}function be(e){e.preventDefault?e.preventDefault():e.returnValue=!1}function we(e){e.stopPropagation?e.stopPropagation():e.cancelBubble=!0}function xe(e){return null!=e.defaultPrevented?e.defaultPrevented:0==e.returnValue}function ke(e){be(e),we(e)}function Ce(e){return e.target||e.srcElement}function Se(e){var t=e.which
return null==t&&(1&e.button?t=1:2&e.button?t=3:4&e.button&&(t=2)),Zi&&e.ctrlKey&&1==t&&(t=3),t}function Le(e){if(null==lo){var t=n("span","​")
r(e,n("span",[t,document.createTextNode("x")])),0!=e.firstChild.offsetHeight&&(lo=t.offsetWidth<=1&&t.offsetHeight>2&&!(Ri&&Bi<8))}var i=lo?n("span","​"):n("span"," ",null,"display: inline-block; width: 1px; margin-right: -1px")
return i.setAttribute("cm-text",""),i}function Te(e){if(null!=so)return so
var n=r(e,document.createTextNode("AخA")),i=to(n,0,1).getBoundingClientRect(),o=to(n,1,2).getBoundingClientRect()
return t(e),!(!i||i.left==i.right)&&(so=o.right-i.right<3)}function Me(e){if("string"==typeof e&&Oo.hasOwnProperty(e))e=Oo[e]
else if(e&&"string"==typeof e.name&&Oo.hasOwnProperty(e.name)){var t=Oo[e.name]
...
var n=r(e,t)
if(Wo.hasOwnProperty(t.name)){var i=Wo[t.name]
...
return n}function Ae(e,t){c(t,Wo.hasOwnProperty(e)?Wo[e]:Wo[e]={})}function Oe(e,t){if(!0===t)return t
...
if(!n.mode.startState)return new Po(n,!0,t)
...
if(u&&(!r||l+(u instanceof Do?u.lookAhead:0)<=o.modeFrontier))return l
var c=d(s.text,null,e.options.tabSize);(null==i||n>c)&&(i=l-1,n=c)}return i}(e,t,r),a=o>n.first&&L(n,o-1).stateAfter,l=a?Po.fromSaved(n,a,o):new Po(n,ze(n.mode),o)
return n.iter(o,t,function(r){Ee(e,r.text,l)
var n=l.line
r.stateAfter=n==t-1||n%5==0||n>=i.viewFrom&&n<i.viewTo?l.save():null,l.nextLine()}),r&&(n.modeFrontier=l.line),l}function Ee(e,t,r,n){var i=e.doc.mode,o=new zo(t,e.options.tabSize,r)
...
var o=e.token(t,r)
if(t.pos>t.start)return o}throw new Error("Mode "+e.name+" failed to advance stream.")}function Re(e,t,r,n){var i,o,a=e.doc,l=a.mode,s=L(a,(t=B(a,t)).line),u=He(e,t.line,r),c=new zo(s.text,e.options.tabSize,u)
for(n&&(o=[]);(n||c.pos<t.ch)&&!c.eol();)c.start=c.pos,i=Fe(l,c,u.state),n&&o.push(new Ho(c,i,Oe(a.mode,u.state)))
return n?o:new Ho(c,i,u.state)}function Be(e,t){if(e)for(;;){var r=e.match(/(?:^|\s+)line-(background-)?(\S+)/)
if(!r)break
...
var s,u=0,c=null,d=new zo(t,e.options.tabSize,n),f=e.options.addModeClass&&[null]
...
var r=t.addModeClass?Ro:Fo
return r[e]||(r[e]=e.replace(/\S+/g,"cm-$&"))}function Ge(e,t){var r=i("span",null,null,ji?"padding-right: .1px":null),n={pre:i("pre",[r],"CodeMirror-line"),content:r,col:0,pos:0,cm:e,trailingSpace:!1,splitSpaces:(Ri||ji)&&e.getOption("lineWrapping")}
t.measure={}
...
break}p=T,c=""}m=i.slice(o,o=r[g++]),a=Ke(r[g++],t.cm.options)}}else for(var N=1;N<r.length;N+=2)t.addToken(t,i.slice(o,o=r[N]),Ke(r[N+1],t.cm.options))}(a,n,Pe(e,a,t!=e.display.externalMeasured&&A(a))),a.styleClasses&&(a.styleClasses.bgClass&&(n.bgClass=s(a.styleClasses.bgClass,n.bgClass||"")),a.styleClasses.textClass&&(n.textClass=s(a.styleClasses.textClass,n.textClass||""))),0==n.map.length&&n.map.push(0,0,n.content.appendChild(Le(e.display.measure))),0==o?(t.measure.map=n.map,t.measure.cache={}):((t.measure.maps||(t.measure.maps=[])).push(n.map),(t.measure.caches||(t.measure.caches=[])).push({}))}if(ji){var u=n.content.lastChild;(/\bcm-tab\b/.test(u.className)||u.querySelector&&u.querySelector(".cm-tab"))&&(n.content.className="cm-tab-wrap-hack")}return pe(e,"renderLine",e,t.line,n.pre),n.pre.className&&(n.textClass=s(n.pre.className,n.textClass||"")),n}function Ue(e){var t=n("span","•","cm-invalidchar")
...
Ri&&Bi<9?s.appendChild(n("span",[m])):s.appendChild(m),e.map.push(e.pos,e.pos+g,m),e.col+=g,e.pos+=g}if(!h)break
f+=g+1
var v=void 0
if("\t"==h[0]){var y=e.cm.options.tabSize,b=y-e.col%y;(v=s.appendChild(n("span",p(b),"cm-tab"))).setAttribute("role","presentation"),v.setAttribute("cm-text","\t"),e.col+=b}else"\r"==h[0]||"\n"==h[0]?((v=s.appendChild(n("span","\r"==h[0]?"␍":"␤","cm-invalidchar"))).setAttribute("cm-text",h[0]),e.col+=1):((v=e.cm.options.specialCharPlaceholder(h[0])).setAttribute("cm-text",h[0]),Ri&&Bi<9?s.appendChild(n("span",[v])):s.appendChild(v),e.col+=1)
e.map.push(e.pos,e.pos+1,v),e.pos++}}else e.col+=t.length,s=document.createTextNode(u),e.map.push(e.pos,e.pos+t.length,s),Ri&&Bi<9&&(d=!0),e.pos+=t.length
...
Bo?n=Bo.delayedCallbacks:jo?n=jo:(n=jo=[],setTimeout(Ze,0))
for(var o=function(e){n.push(function(){return r[e].apply(null,i)})},a=0;a<r.length;++a)o(a)}}function Ze(){var e=jo
jo=null
...
it(e,t,r)}(e,t,n)}t.changes=null}function Je(e){return e.node==e.text&&(e.node=n("div",null,null,"position: relative"),e.text.parentNode&&e.text.parentNode.replaceChild(e.node,e.text),e.node.appendChild(e.text),Ri&&Bi<8&&(e.node.style.zIndex=2)),e.node}function et(e,t){var r=e.display.externalMeasured
...
if((a=Ri&&Bi<9&&0==u&&c==l.coverEnd-l.coverStart?s.parentNode.getBoundingClientRect():function(e,t){var r=Vo
if("left"==t)for(var n=0;n<e.length&&(r=e[n]).left==r.right;n++);else for(var i=e.length-1;i>=0&&(r=e[i]).left==r.right;i--);return r}(to(s,u,c).getClientRects(),o)).left||a.right||0==u)break
c=u,u-=1,d="right"}Ri&&Bi<11&&(a=function(e,t){if(!window.screen||null==screen.logicalXDPI||screen.logicalXDPI==screen.deviceXDPI||!function(e){if(null!=No)return No
var t=r(e,n("span","x")),i=t.getBoundingClientRect(),o=to(t,0,1).getBoundingClientRect()
return No=Math.abs(i.left-o.left)>1}(e))return t
...
var h
a=e.options.lineWrapping&&(h=s.getClientRects()).length>1?h["right"==o?h.length-1:0]:s.getBoundingClientRect()}if(Ri&&Bi<9&&!u&&(!a||!a.left&&!a.right)){var p=s.parentNode.getClientRects()[0]
a=p?{left:p.left,right:p.left+It(e.display),top:p.top,bottom:p.bottom}:Vo}for(var g=a.top-t.rect.top,m=a.bottom-t.rect.top,v=(g+m)/2,y=t.view.measure.heights,b=0;b<y.length-1&&!(v<y[b]);b++);var w=b?y[b-1]:0,x=y[b],C={left:("right"==d?a.right:a.left)-t.rect.left,right:("left"==d?a.left:a.right)-t.rect.left,top:w,bottom:x}
...
for(var r=0;r<e.display.view.length;r++)wt(e.display.view[r])}function kt(e){xt(e),e.display.cachedCharWidth=e.display.cachedTextHeight=e.display.cachedPaddingH=null,e.options.lineWrapping||(e.display.maxLineChanged=!0),e.display.lineNumChars=null}function Ct(){return Ki&&Xi?-(document.body.getBoundingClientRect().left-parseInt(getComputedStyle(document.body).marginLeft)):window.pageXOffset||(document.documentElement||document.body).scrollLeft}function St(){return Ki&&Xi?-(document.body.getBoundingClientRect().top-parseInt(getComputedStyle(document.body).marginTop)):window.pageYOffset||(document.documentElement||document.body).scrollTop}function Lt(e){var t=0
...
var d=ce(s,u,c),f=wo,h=l(u,d,"before"==c)
...
if(null==Io){Io=n("pre")
for(var i=0;i<49;++i)Io.appendChild(document.createTextNode("x")),Io.appendChild(n("br"))
Io.appendChild(document.createTextNode("x"))}r(e.measure,Io)
var o=Io.offsetHeight/50
...
var r=!0
t.cursorDiv.style.visibility="",e.options.cursorBlinkRate>0?t.blinker=setInterval(function(){return t.cursorDiv.style.visibility=(r=!r)?"":"hidden"},e.options.cursorBlinkRate):e.options.cursorBlinkRate<0&&(t.cursorDiv.style.visibility="hidden")}}function Xt(e){e.state.focused||(e.display.input.focus(),Zt(e))}function Yt(e){e.state.delayingBlurEvent=!0,setTimeout(function(){e.state.delayingBlurEvent&&(e.state.delayingBlurEvent=!1,Qt(e))},100)}function Zt(e,t){e.state.delayingBlurEvent&&(e.state.delayingBlurEvent=!1),"nocursor"!=e.options.readOnly&&(e.state.focused||(pe(e,"focus",e,t),e.state.focused=!0,l(e.display.wrapper,"CodeMirror-focused"),e.curOp||e.display.selForContextMenu==e.doc.sel||(e.display.input.reset(),ji&&setTimeout(function(){return e.display.input.reset(!0)},20)),e.display.input.receivedFocus()),_t(e))}function Qt(e,t){e.state.delayingBlurEvent||(e.state.focused&&(pe(e,"blur",e,t),e.state.focused=!1,io(e.display.wrapper,"CodeMirror-focused")),clearInterval(e.display.blinker),setTimeout(function(){e.state.focused||(e.display.shift=!1)},150))}function Jt(e){for(var t=e.display,r=t.lineDiv.offsetTop,n=0;n<t.view.length;n++){var i=t.view[n],o=void 0
if(!i.hidden){if(Ri&&Bi<8){var a=i.node.offsetTop+i.node.offsetHeight
o=a-r,r=a}else{var l=i.node.getBoundingClientRect()
o=l.bottom-l.top}var s=i.line.height-o
if(o<2&&(o=Et(t)),(s>.005||s<-.005)&&(N(i.line,o),er(i.line),i.rest))for(var u=0;u<i.rest.length;u++)er(i.rest[u])}}}function er(e){if(e.widgets)for(var t=0;t<e.widgets.length;++t)e.widgets[t].height=e.widgets[t].node.parentNode.offsetHeight}function tr(e,t,r){var n=r&&null!=r.top?Math.max(0,r.top):e.scroller.scrollTop
n=Math.floor(n-st(e))
...
r.sizer.style.paddingRight=(r.barWidth=n.right)+"px",r.sizer.style.paddingBottom=(r.barHeight=n.bottom)+"px",r.heightForcer.style.borderBottom=n.bottom+"px solid transparent",n.right&&n.bottom?(r.scrollbarFiller.style.display="block",r.scrollbarFiller.style.height=n.bottom+"px",r.scrollbarFiller.style.width=n.right+"px"):r.scrollbarFiller.style.display="",n.bottom&&e.options.coverGutterNextToScrollbar&&e.options.fixedGutter?(r.gutterFiller.style.display="block",r.gutterFiller.style.height=n.bottom+"px",r.gutterFiller.style.width=t.gutterWidth+"px"):r.gutterFiller.style.display=""}function mr(e){e.display.scrollbars&&(e.display.scrollbars.clear(),e.display.scrollbars.addClass&&io(e.display.wrapper,e.display.scrollbars.addClass)),e.display.scrollbars=new Uo[e.options.scrollbarStyle](function(t){e.display.wrapper.insertBefore(t,e.display.scrollbarFiller),Co(t,"mousedown",function(){e.state.focused&&setTimeout(function(){return e.display.input.focus()},0)}),t.setAttribute("cm-not-content","true")},function(t,r){"horizontal"==r?fr(e,t):cr(e,t)},e),e.display.scrollbars.addClass&&l(e.display.wrapper,e.display.scrollbars.addClass)}function vr(e){e.curOp={cm:e,viewChanged:!1,startHeight:e.doc.height,forceUpdate:!1,updateInput:null,typing:!1,changeObjs:null,cursorActivityHandlers:null,cursorActivityCalled:0,selectionChanged:!1,updateMaxLine:!1,scrollLeft:null,scrollTop:null,scrollToPos:null,focus:!1,id:++qo},function(e){Bo?Bo.ops.push(e):e.ownsGroup=Bo={ops:[e],delayedCallbacks:[]}}(e.curOp)}function yr(e){!function(e,t){var r=e.ownsGroup
...
if(t.top+i.top<0?o=!0:t.bottom+i.top>(window.innerHeight||document.documentElement.clientHeight)&&(o=!1),null!=o&&!$i){var a=n("div","​",null,"position: absolute;\n                         top: "+(t.top-r.viewOffset-st(e.display))+"px;\n                         height: "+(t.bottom-t.top+dt(e)+r.barHeight)+"px;\n                         left: "+t.left+"px; width: "+Math.max(2,t.right-t.left)+"px;")
...
var i=e.display
if(n&&r<i.viewTo&&(null==i.updateLineNumbers||i.updateLineNumbers>t)&&(i.updateLineNumbers=t),e.curOp.viewChanged=!0,t>=i.viewTo)bo&&ne(e.doc,t)<i.viewTo&&Lr(e)
else if(r<=i.viewFrom)bo&&ie(e.doc,r+n)>i.viewFrom?Lr(e):(i.viewFrom+=n,i.viewTo+=n)
...
if(!bo||r==e.doc.first+e.doc.size)return{index:o,lineN:r}
...
n.viewFrom<s&&s-n.viewFrom<20&&(s=Math.max(i.first,n.viewFrom)),n.viewTo>u&&n.viewTo-u<20&&(u=Math.min(l,n.viewTo)),bo&&(s=ne(e.doc,s),u=ie(e.doc,u))
...
return ji&&Zi&&e.display.currentWheelTarget==t?t.style.display="none":t.parentNode.removeChild(t),r}for(var o=e.display,a=e.options.lineNumbers,l=o.lineDiv,s=l.firstChild,u=o.view,c=o.viewFrom,d=0;d<u.length;d++){var h=u[d]
...
return t.x*=Xo,t.y*=Xo,t}function Rr(e,t){var r=Ir(t),n=r.x,i=r.y,o=e.display,a=o.scroller,l=a.scrollWidth>a.clientWidth,s=a.scrollHeight>a.clientHeight
if(n&&l||i&&s){if(i&&Zi&&ji)e:for(var u=t.target,c=o.view;u!=a;u=u.parentNode)for(var d=0;d<c.length;d++)if(c[d].node==u){e.display.currentWheelTarget=u
break e}if(n&&!Hi&&!Gi&&null!=Xo)return i&&s&&cr(e,Math.max(0,a.scrollTop+i*Xo)),fr(e,Math.max(0,a.scrollLeft+n*Xo)),(!i||i&&s)&&be(t),void(o.wheelStartX=null)
if(i&&null!=Xo){var f=i*Xo,h=e.doc.scrollTop,p=h+o.wrapper.clientHeight
f<0?h=Math.max(0,h+f-50):p=Math.min(e.doc.height,p+f+50),zr(e,{top:h,bottom:p})}_o<20&&(null==o.wheelStartX?(o.wheelStartX=a.scrollLeft,o.wheelStartY=a.scrollTop,o.wheelDX=n,o.wheelDY=i,setTimeout(function(){if(null!=o.wheelStartX){var e=a.scrollLeft-o.wheelStartX,t=a.scrollTop-o.wheelStartY,r=t&&o.wheelDY&&t/o.wheelDY||e&&o.wheelDX&&e/o.wheelDX
o.wheelStartX=o.wheelStartY=null,r&&(Xo=(Xo*_o+r)/(_o+1),++_o)}},200)):(o.wheelDX+=n,o.wheelDY+=i))}}function Br(e,t){var r=e[t]
...
n<=t&&--t,e.splice(--n,2,new Zo(s?l:a,s?a:l))}}return new Yo(e,t)}function jr(e,t){return new Yo([new Zo(e,t||e)],0)}function Vr(e){return e.text?D(e.from.line+e.text.length-1,g(e.text).length+(1==e.text.length?e.from.ch:0)):e.to}function Kr(e,t){if(P(e,t.from)<0)return e
...
v.push(new Eo(f+c.text.slice(s.ch),h,n)),o(c,c.text.slice(0,l.ch)+u[0],i(0)),e.insert(l.line+1,v)}else if(1==u.length)o(c,c.text.slice(0,l.ch)+u[0]+d.text.slice(s.ch),i(0)),e.remove(l.line+1,p)
...
if(o.ranges)n.push(r?Yo.prototype.deepCopy.call(o):o)
...
if(r){var o=P(t,i)<0
o!=P(r,i)<0?(i=t,t=r):o!=P(t,r)<0&&(t=r)}return new Zo(i,t)}return new Zo(r||t,t)}function cn(e,t,r,n,i){null==i&&(i=e.cm&&(e.cm.display.shift||e.extend)),gn(e,new Yo([un(e.sel.primary(),t,r,i)],0),n)}function dn(e,t,r){for(var n=[],i=e.cm&&(e.cm.display.shift||e.extend),o=0;o<e.sel.ranges.length;o++)n[o]=un(e.sel.ranges[o],t[o],null,i)
...
if(e.cm.state.suppressEdits)return}if(!(ve(e,"beforeChange")||e.cm&&ve(e.cm,"beforeChange"))||(t=Sn(e,t,!0))){var n=yo&&!r&&function(e,t,r){var n=null
...
if(p)return p.v}}}}function Nn(e,t){if(0!=t&&(e.first+=t,e.sel=new Yo(m(e.sel.ranges,function(e){return new Zo(D(e.anchor.line+t,e.anchor.ch),D(e.head.line+t,e.head.ch))}),e.sel.primIndex),e.cm)){Cr(e.cm,e.first,e.first-t,t)
...
if(i&&(!(i instanceof Do)||n+i.lookAhead<t)){r=n+1
...
d&&Ye(e,"change",e,f),c&&(e.curOp.changeObjs||(e.curOp.changeObjs=[])).push(f)}e.display.selForContextMenu=null}(e.cm,t,n):Xr(e,t,n),mn(e,r,fo)}}function On(e,t,r,n,i){if(n||(n=r),P(n,r)<0){var o
...
a=g(o)}),new ta(o,a)}(e,t,r,n,o)
if(e.cm&&!e.cm.curOp)return wr(e.cm,Fn)(e,t,r,n,o)
var a=new ea(e,o),l=P(t,r)
...
if(Vn(t),!ge(t,e)&&!lt(t.display,e)){be(e),Ri&&(ia=+new Date)
...
if(a)return a}}}function _n(e){var t="string"==typeof e?e:aa[e.keyCode]
return"Ctrl"==t||"Alt"==t||"Shift"==t||"Mod"==t}function Xn(e,t,r){var n=e
return t.altKey&&"Alt"!=n&&(e="Alt-"+e),(ro?t.metaKey:t.ctrlKey)&&"Ctrl"!=n&&(e="Ctrl-"+e),(ro?t.ctrlKey:t.metaKey)&&"Cmd"!=n&&(e="Cmd-"+e),!r&&t.shiftKey&&"Shift"!=n&&(e="Shift-"+e),e}function Yn(e,t){if(Gi&&34==e.keyCode&&e.char)return!1
var r=aa[e.keyCode]
return null!=r&&!e.altGraphKey&&Xn(r,e,t)}function Zn(e){return"string"==typeof e?ca[e]:e}function Qn(e,t){for(var r=e.doc.sel.ranges,n=[],i=0;i<r.length;i++){for(var o=t(r[i]);n.length&&P(o.from,g(n).to)<=0;){var a=n.pop()
...
return D(r.line,a?0:o,r.sticky)}return r}function ii(e,t,r){if("string"==typeof t&&!(t=da[t]))return!1
e.display.input.ensurePolled()
var n=e.display.shift,i=!1
try{e.isReadOnly()&&(e.state.suppressEdits=!0),r&&(e.display.shift=!1),i=t(e)!=co}finally{e.display.shift=n,e.state.suppressEdits=!1}return i}function oi(e,t,r,n){var i=e.state.keySeq
if(i){if(_n(t))return"handled"
fa.set(50,function(){e.state.keySeq==i&&(e.state.keySeq=null,e.display.input.reset())}),t=i+" "+t}var o=function(e,t,r){for(var n=0;n<e.state.keyMaps.length;n++){var i=$n(t,e.state.keyMaps[n],r,e)
if(i)return i}return e.options.extraKeys&&$n(t,e.options.extraKeys,r,e)||$n(t,e.options.keyMap,r,e)}(e,t,n)
return"multi"==o&&(e.state.keySeq=t),"handled"==o&&Ye(e,"keyHandled",e,t,r),"handled"!=o&&"multi"!=o||(be(r),_t(e)),i&&!o&&/\'$/.test(t)?(be(r),!0):!!o}function ai(e,t){var r=Yn(t,!0)
return!!r&&(t.shiftKey&&!e.state.keySeq?oi(e,"Shift-"+r,t,function(t){return ii(e,t,!0)})||oi(e,r,t,function(t){if("string"==typeof t?/^go[A-Z]/.test(t):t.motion)return ii(e,t)}):oi(e,r,t,function(t){return ii(e,t)}))}function li(e){var t=this
if(t.curOp.focus=a(),!ge(t,e)){Ri&&Bi<11&&27==e.keyCode&&(e.returnValue=!1)
var r=e.keyCode
t.display.shift=16==r||e.shiftKey
var n=ai(t,e)
Gi&&(ha=n?r:null,!n&&88==r&&!Mo&&(Zi?e.metaKey:e.ctrlKey)&&t.replaceSelection("",null,"cut")),18!=r||/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className)||function(e){function t(e){18!=e.keyCode&&e.altKey||(io(r,"CodeMirror-crosshair"),he(document,"keyup",t),he(document,"mouseover",t))}var r=e.display.lineDiv
l(r,"CodeMirror-crosshair"),Co(document,"keyup",t),Co(document,"mouseover",t)}(t)}}function si(e){16==e.keyCode&&(this.doc.sel.shift=!1),ge(this,e)}function ui(e){var t=this
if(!(lt(t.display,e)||ge(t,e)||e.ctrlKey&&!e.altKey||Zi&&e.metaKey)){var r=e.keyCode,n=e.charCode
if(Gi&&r==ha)return ha=null,void be(e)
if(!Gi||e.which&&!(e.which<10)||!ai(t,e)){var i=String.fromCharCode(null==n?r:n)
"\b"!=i&&(function(e,t,r){return oi(e,"'"+i+"'",t,function(t){return ii(e,t,!0)})}(t,e)||t.display.input.onKeyPress(e))}}}function ci(e){var t=this,r=t.display
if(!(ge(t,e)||r.activeTouch&&r.input.supportsTouch()))if(r.input.ensurePolled(),r.shift=e.shiftKey,lt(r,e))ji||(r.scroller.draggable=!1,setTimeout(function(){return r.scroller.draggable=!0},100))
else if(!hi(t,e)){var n=Vt(t,e),i=Se(e),o=n?function(e,t){var r=+new Date
return ma&&ma.compare(r,e,t)?(ga=ma=null,"triple"):ga&&ga.compare(r,e,t)?(ma=new pa(r,e,t),ga=null,"double"):(ga=new pa(r,e,t),ma=null,"single")}(n,i):"single"
window.focus(),1==i&&t.state.selectingText&&t.state.selectingText(e),n&&function(e,t,r,n,i){var o="Click"
return"double"==n?o="Double"+o:"triple"==n&&(o="Triple"+o),o=(1==t?"Left":2==t?"Middle":"Right")+o,oi(e,Xn(o,i),i,function(t){if("string"==typeof t&&(t=da[t]),!t)return!1
var n=!1
try{e.isReadOnly()&&(e.state.suppressEdits=!0),n=t(e,r)!=co}finally{e.state.suppressEdits=!1}return n})}(t,i,n,o,e)||(1==i?n?function(e,t,r,n){Ri?setTimeout(u(Xt,e),0):e.curOp.focus=a()
var i,o=function(e,t,r){var n=e.getOption("configureMouse"),i=n?n(e,t,r):{}
if(null==i.unit){var o=Qi?r.shiftKey&&r.metaKey:r.altKey
...
e.options.dragDrop&&So&&!e.isReadOnly()&&"single"==r&&(i=l.contains(t))>-1&&(P((i=l.ranges[i]).from(),t)<0||t.xRel>0)&&(P(i.to(),t)>0||t.xRel<0)?function(e,t,r,n){var i=e.display,o=!1,a=wr(e,function(t){ji&&(i.scroller.draggable=!1),e.state.draggingText=!1,he(document,"mouseup",a),he(document,"mousemove",l),he(i.scroller,"dragstart",s),he(i.scroller,"drop",a),o||(be(t),n.addNew||cn(e.doc,r,null,null,n.extend),ji||Ri&&9==Bi?setTimeout(function(){document.body.focus(),i.input.focus()},20):i.input.focus())}),l=function(e){o=o||Math.abs(t.clientX-e.clientX)+Math.abs(t.clientY-e.clientY)>=10},s=function(){return o=!0}
ji&&(i.scroller.draggable=!0),e.state.draggingText=a,a.copy=!n.moveOnDrag,i.scroller.dragDrop&&i.scroller.dragDrop(),Co(document,"mouseup",a),Co(document,"mousemove",l),Co(i.scroller,"dragstart",s),Co(i.scroller,"drop",a),Yt(e),setTimeout(function(){return i.input.focus()},20)}(e,n,t,o):function(e,t,r,n){function i(t){if(0!=P(v,t))if(v=t,"rectangle"==n.unit){for(var i=[],o=e.options.tabSize,a=d(L(u,r.line).text,r.ch,o),l=d(L(u,t.line).text,t.ch,o),s=Math.min(a,l),g=Math.max(a,l),m=Math.min(r.line,t.line),y=Math.min(e.lastLine(),Math.max(r.line,t.line));m<=y;m++){var b=L(u,m).text,w=h(b,s,o)
s==g?i.push(new Zo(D(m,w),D(m,w))):b.length>w&&i.push(new Zo(D(m,w),D(m,h(b,g,o))))}i.length||i.push(new Zo(r,r)),gn(u,Br(p.ranges.slice(0,f).concat(i),f),{origin:"*mouse",scroll:!1}),e.scrollIntoView(t)}else{var x,k=c,C=di(e,t,n.unit),S=k.anchor
...
return r.ch==p&&r.sticky==g?t:new Zo(new D(r.line,p,g),n)}(e,new Zo(B(u,S),x)),gn(u,Br(T,f),ho)}}function o(t){var r=++b,l=Vt(e,t,!0,"rectangle"==n.unit)
...
if(n.addNew&&!n.extend?(f=u.sel.contains(r),c=f>-1?g[f]:new Zo(r,r)):(c=u.sel.primary(),f=u.sel.primIndex),"rectangle"==n.unit)n.addNew||(c=new Zo(r,r)),r=Vt(e,t,!0,!0),f=-1
else{var m=di(e,r,n.unit)
c=n.extend?un(c,m.anchor,m.head,n.extend):m}n.addNew?-1==f?(f=g.length,gn(u,Br(g.concat([c]),f),{scroll:!1,origin:"*mouse"})):g.length>1&&g[f].empty()&&"char"==n.unit&&!n.extend?(gn(u,Br(g.slice(0,f).concat(g.slice(f+1)),0),{scroll:!1,origin:"*mouse"}),p=u.sel):fn(u,f,c,ho):(f=0,gn(u,new Yo([c],0),ho),p=u.sel)
var v=r,y=s.wrapper.getBoundingClientRect(),b=0,w=wr(e,function(e){Se(e)?o(e):l(e)}),x=wr(e,l)
e.state.selectingText=x,Co(document,"mousemove",w),Co(document,"mouseup",x)}(e,n,t,o)}(t,n,o,e):Ce(e)==r.scroller&&be(e):2==i?(n&&cn(t.doc,n),setTimeout(function(){return r.input.focus()},20)):3==i&&(no?pi(t,e):Yt(t)))}}function di(e,t,r){if("char"==r)return new Zo(t,t)
if("word"==r)return e.findWordAt(t)
if("line"==r)return new Zo(D(t.line,0),B(e.doc,D(t.line+1,0)))
var n=r(e,t)
return new Zo(n.from,n.to)}function fi(e,t,r,n){var i,o
...
if(u&&u.getBoundingClientRect().right>=i)return pe(e,r,e,O(e.doc,o),e.options.gutters[s],t),xe(t)}}function hi(e,t){return fi(e,t,"gutterClick",!0)}function pi(e,t){lt(e.display,t)||function(e,t){return!!ve(e,"gutterContextMenu")&&fi(e,t,"gutterContextMenu",!1)}(e,t)||ge(e,t,"contextmenu")||e.display.input.onContextMenu(t)}function gi(e){e.display.wrapper.className=e.display.wrapper.className.replace(/\s*cm-s-\S+/g,"")+e.options.theme.replace(/(^|\s)\s*/g," cm-s-"),kt(e)}function mi(e){Hr(e),Cr(e),rr(e)}function vi(e,t,r){if(!t!=!(r&&r!=va)){var n=e.display.dragFunctions,i=t?Co:he
i(e.display.scroller,"dragstart",n.start),i(e.display.scroller,"dragenter",n.enter),i(e.display.scroller,"dragover",n.over),i(e.display.scroller,"dragleave",n.leave),i(e.display.scroller,"drop",n.drop)}}function yi(e){e.options.lineWrapping?(l(e.display.wrapper,"CodeMirror-wrap"),e.display.sizer.style.minWidth="",e.display.sizerWidth=null):(io(e.display.wrapper,"CodeMirror-wrap"),ue(e)),jt(e),Cr(e),kt(e),setTimeout(function(){return pr(e)},100)}function bi(e,t){var o=this
if(!(this instanceof bi))return new bi(e,t)
this.options=t=t?c(t):{},c(ya,t,!1),Er(t)
var a=t.value
"string"==typeof a&&(a=new na(a,t.mode,null,t.lineSeparator,t.direction)),this.doc=a
var l=new bi.inputStyles[t.inputStyle](this),s=this.display=new function(e,t,r){var o=this
...
o.mover=n("div",[a],null,"position: relative"),o.sizer=n("div",[o.mover],"CodeMirror-sizer"),o.sizerWidth=null,o.heightForcer=n("div",null,null,"position: absolute; height: "+uo+"px; width: 1px;"),o.gutters=n("div",null,"CodeMirror-gutters"),o.lineGutter=null,o.scroller=n("div",[o.sizer,o.heightForcer,o.gutters],"CodeMirror-scroll"),o.scroller.setAttribute("tabIndex","-1"),o.wrapper=n("div",[o.scrollbarFiller,o.gutterFiller,o.scroller],"CodeMirror"),Ri&&Bi<8&&(o.gutters.style.zIndex=-1,o.scroller.style.paddingRight=0),ji||Hi&&Yi||(o.scroller.draggable=!0),e&&(e.appendChild?e.appendChild(o.wrapper):e(o.wrapper)),o.viewFrom=o.viewTo=t.first,o.reportedViewFrom=o.reportedViewTo=t.first,o.view=[],o.renderedView=null,o.externalMeasured=null,o.viewOffset=0,o.lastWrapHeight=o.lastWrapWidth=0,o.updateLineNumbers=null,o.nativeBarWidth=o.barHeight=o.barWidth=0,o.scrollbarsClipped=!1,o.lineNumWidth=o.lineNumInnerWidth=o.lineNumChars=null,o.alignWidgets=!1,o.cachedCharWidth=o.cachedTextHeight=o.cachedPaddingH=null,o.maxLine=null,o.maxLineLength=0,o.maxLineChanged=!1,o.wheelDX=o.wheelDY=o.wheelStartX=o.wheelStartY=null,o.shift=!1,o.selForContextMenu=null,o.activeTouch=null,r.init(o)}(e,a,l)
s.wrapper.CodeMirror=this,Hr(this),gi(this),t.lineWrapping&&(this.display.wrapper.className+=" CodeMirror-wrap"),mr(this),this.state={keyMaps:[],overlays:[],modeGen:0,overwrite:!1,delayingBlurEvent:!1,focused:!1,suppressEdits:!1,pasteIncoming:!1,cutIncoming:!1,selectingText:!1,draggingText:!1,highlight:new ao,keySeq:null,specialChars:null},t.autofocus&&!Yi&&s.input.focus(),Ri&&Bi<11&&setTimeout(function(){return o.display.input.reset(!0)},20),function(e){function t(){o.activeTouch&&(a=setTimeout(function(){return o.activeTouch=null},1e3),(l=o.activeTouch).end=+new Date)}function i(e,t){if(null==t.left)return!0
var r=t.left-e.left,n=t.top-e.top
return r*r+n*n>400}var o=e.display
Co(o.scroller,"mousedown",wr(e,ci)),Ri&&Bi<11?Co(o.scroller,"dblclick",wr(e,function(t){if(!ge(e,t)){var r=Vt(e,t)
if(r&&!hi(e,t)&&!lt(e.display,t)){be(t)
var n=e.findWordAt(r)
cn(e.doc,n.anchor,n.head)}}})):Co(o.scroller,"dblclick",function(t){return ge(e,t)||be(t)}),no||Co(o.scroller,"contextmenu",function(t){return pi(e,t)})
var a,l={end:0}
Co(o.scroller,"touchstart",function(t){if(!ge(e,t)&&!function(e){if(1!=e.touches.length)return!1
var t=e.touches[0]
return t.radiusX<=1&&t.radiusY<=1}(t)&&!hi(e,t)){o.input.ensurePolled(),clearTimeout(a)
var r=+new Date
o.activeTouch={start:r,moved:!1,prev:r-l.end<=300?l:null},1==t.touches.length&&(o.activeTouch.left=t.touches[0].pageX,o.activeTouch.top=t.touches[0].pageY)}}),Co(o.scroller,"touchmove",function(){o.activeTouch&&(o.activeTouch.moved=!0)}),Co(o.scroller,"touchend",function(r){var n=o.activeTouch
if(n&&!lt(o,r)&&null!=n.left&&!n.moved&&new Date-n.start<300){var a,l=e.coordsChar(o.activeTouch,"page")
a=!n.prev||i(n,n.prev)?new Zo(l,l):!n.prev.prev||i(n,n.prev.prev)?e.findWordAt(l):new Zo(D(l.line,0),B(e.doc,D(l.line+1,0))),e.setSelection(a.anchor,a.head),e.focus(),be(r)}t()}),Co(o.scroller,"touchcancel",t),Co(o.scroller,"scroll",function(){o.scroller.clientHeight&&(cr(e,o.scroller.scrollTop),fr(e,o.scroller.scrollLeft,!0),pe(e,"scroll",e))}),Co(o.scroller,"mousewheel",function(t){return Rr(e,t)}),Co(o.scroller,"DOMMouseScroll",function(t){return Rr(e,t)}),Co(o.wrapper,"scroll",function(){return o.wrapper.scrollTop=o.wrapper.scrollLeft=0}),o.dragFunctions={enter:function(t){ge(e,t)||ke(t)},over:function(t){ge(e,t)||(function(e,t){var i=Vt(e,t)
if(i){var o=document.createDocumentFragment()
qt(e,i,o),e.display.dragCursor||(e.display.dragCursor=n("div",null,"CodeMirror-cursors CodeMirror-dragcursors"),e.display.lineSpace.insertBefore(e.display.dragCursor,e.display.cursorDiv)),r(e.display.dragCursor,o)}}(e,t),ke(t))},start:function(t){return function(e,t){if(Ri&&(!e.state.draggingText||+new Date-ia<100))ke(t)
else if(!ge(e,t)&&!lt(e.display,t)&&(t.dataTransfer.setData("Text",e.getSelection()),t.dataTransfer.effectAllowed="copyMove",t.dataTransfer.setDragImage&&!Ui)){var r=n("img",null,null,"position: fixed; left: 0; top: 0;")
r.src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",Gi&&(r.width=r.height=1,e.display.wrapper.appendChild(r),r._top=r.offsetTop),t.dataTransfer.setDragImage(r,0,0),Gi&&r.parentNode.removeChild(r)}}(e,t)},drop:wr(e,jn),leave:function(t){ge(e,t)||Vn(e)}}
var s=o.input.getField()
Co(s,"keyup",function(t){return si.call(e,t)}),Co(s,"keydown",wr(e,li)),Co(s,"keypress",wr(e,ui)),Co(s,"focus",function(t){return Zt(e,t)}),Co(s,"blur",function(t){return Qt(e,t)})}(this),oa||(function(){var e
Co(window,"resize",function(){null==e&&(e=setTimeout(function(){e=null,Kn(Gn)},100))}),Co(window,"blur",function(){return Kn(Qt)})}(),oa=!0),vr(this),this.curOp.forceUpdate=!0,Zr(this,a),t.autofocus&&!Yi||this.hasFocus()?setTimeout(u(Zt,this),20):Qt(this)
for(var d in ba)ba.hasOwnProperty(d)&&ba[d](o,t[d],va)
nr(this),t.finishInit&&t.finishInit(this)
for(var f=0;f<wa.length;++f)wa[f](o)
yr(this),ji&&t.lineWrapping&&"optimizelegibility"==getComputedStyle(s.lineDiv).textRendering&&(s.lineDiv.style.textRendering="auto")}function wi(e,t,r,n){var i,o=e.doc
...
if(n||/\S/.test(l.text)){if("smart"==r&&((u=o.mode.indent(i,l.text.slice(c.length),l.text))==co||u>150)){if(!n)return
...
fn(o,m,new Zo(y,y))
break}}}function xi(e){xa=e}function ki(e,t,r,n,i){var o=e.doc
e.display.shift=!1,n||(n=o.sel)
var a=e.state.pasteIncoming||"paste"==i,l=Lo(t),s=null
if(a&&n.ranges.length>1)if(xa&&xa.text.join("\n")==t){if(n.ranges.length%xa.text.length==0){s=[]
for(var u=0;u<xa.text.length;u++)s.push(o.splitLines(xa.text[u]))}}else l.length==n.ranges.length&&e.options.pasteLinesPerSelection&&(s=m(l,function(e){return[e]}))
for(var c,d=n.ranges.length-1;d>=0;d--){var f=n.ranges[d],h=f.from(),p=f.to()
f.empty()&&(r&&r>0?h=D(h.line,h.ch-r):e.state.overwrite&&!a?p=D(p.line,Math.min(L(o,p.line).text.length,p.ch+g(l).length)):xa&&xa.lineWise&&xa.text.join("\n")==t&&(h=p=D(h.line,0))),c=e.curOp.updateInput
var v={from:h,to:p,text:s?s[d%s.length]:l,origin:i||(a?"paste":e.state.cutIncoming?"cut":"+input")}
Ln(e.doc,v),Ye(e,"inputRead",e,v)}t&&!a&&Si(e,t),ar(e),e.curOp.updateInput=c,e.curOp.typing=!0,e.state.pasteIncoming=e.state.cutIncoming=!1}function Ci(e,t){var r=e.clipboardData&&e.clipboardData.getData("Text")
if(r)return e.preventDefault(),t.isReadOnly()||t.options.disableInput||br(t,function(){return ki(t,r,0,null,"paste")}),!0}function Si(e,t){if(e.options.electricChars&&e.options.smartIndent)for(var r=e.doc.sel,n=r.ranges.length-1;n>=0;n--){var i=r.ranges[n]
if(!(i.head.ch>100||n&&r.ranges[n-1].head.line==i.head.line)){var o=e.getModeAt(i.head),a=!1
if(o.electricChars){for(var l=0;l<o.electricChars.length;l++)if(t.indexOf(o.electricChars.charAt(l))>-1){a=wi(e,i.head.line,"smart")
break}}else o.electricInput&&o.electricInput.test(L(e.doc,i.head.line).text.slice(0,i.head.ch))&&(a=wi(e,i.head.line,"smart"))
a&&Ye(e,"electricInput",e,i.head.line)}}}function Li(e){for(var t=[],r=[],n=0;n<e.doc.sel.ranges.length;n++){var i=e.doc.sel.ranges[n].head.line,o={anchor:D(i,0),head:D(i+1,0)}
r.push(o),t.push(e.getRange(o.anchor,o.head))}return{text:t,ranges:r}}function Ti(e,t){e.setAttribute("autocorrect","off"),e.setAttribute("autocapitalize","off"),e.setAttribute("spellcheck",!!t)}function Mi(){var e=n("textarea",null,null,"position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none"),t=n("div",[e],null,"overflow: hidden; position: relative; width: 3px; height: 0px;")
return ji?e.style.width="1000px":e.setAttribute("wrap","off"),_i&&(e.style.border="1px solid black"),Ti(e),t}function Ni(e,t,r,n,i){function o(n){var o
...
return H(a,g)&&(g.hitSide=!0),g}function Ai(e,t,r,n){var i,o=e.doc,a=t.left
...
break}i+=5*r}return u}function Oi(e,t){var r=mt(e,t.line)
if(!r||r.hidden)return null
var n=L(e.doc,t.line),i=pt(r,n,t.line),o=de(n,e.doc.direction),a="left"
o&&(a=ce(o,t.ch)%2?"right":"left")
var l=bt(i.map,t.ch,a)
return l.offset="right"==l.collapse?l.end:l.start,l}function Wi(e,t){return t&&(e.bad=!0),e}function zi(e,t,r){var n
if(t==e.display.lineDiv){if(!(n=e.display.lineDiv.childNodes[r]))return Wi(e.clipPos(D(e.display.viewTo-1)),!0)
...
if(!t||!o(i,t))return Wi(D(A(e.line),0),!0)
if(t==i&&(a=!0,t=i.childNodes[r],r=0,!t)){var l=e.rest?g(e.rest):e.line
return Wi(D(A(l),l.text.length),a)}var s=3==t.nodeType?t:null,u=t
...
if(f)return Wi(f,a)
for(var h=u.nextSibling,p=s?s.nodeValue.length-r:0;h;h=h.nextSibling){if(f=n(h,h.firstChild,0))return Wi(D(f.line,f.ch-p),a)
p+=h.textContent.length}for(var m=u.previousSibling,v=r;m;m=m.previousSibling){if(f=n(m,m.firstChild,-1))return Wi(D(f.line,f.ch+v),a)
v+=m.textContent.length}}(a,t,r)}}var Di=navigator.userAgent,Pi=navigator.platform,Hi=/gecko\/\d/i.test(Di),Ei=/MSIE \d/.test(Di),Ii=/Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Di),Fi=/Edge\/(\d+)/.exec(Di),Ri=Ei||Ii||Fi,Bi=Ri&&(Ei?document.documentMode||6:+(Fi||Ii)[1]),ji=!Fi&&/WebKit\//.test(Di),Vi=ji&&/Qt\/\d+\.\d+/.test(Di),Ki=!Fi&&/Chrome\//.test(Di),Gi=/Opera\//.test(Di),Ui=/Apple Computer/.test(navigator.vendor),qi=/Mac OS X 1\d\D([8-9]|\d\d)\D/.test(Di),$i=/PhantomJS/.test(Di),_i=!Fi&&/AppleWebKit/.test(Di)&&/Mobile\/\w+/.test(Di),Xi=/Android/.test(Di),Yi=_i||Xi||/webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(Di),Zi=_i||/Mac/.test(Pi),Qi=/\bCrOS\b/.test(Di),Ji=/win/i.test(Pi),eo=Gi&&Di.match(/Version\/(\d*\.\d*)/)
eo&&(eo=Number(eo[1])),eo&&eo>=15&&(Gi=!1,ji=!0)
var to,ro=Zi&&(Vi||Gi&&(null==eo||eo<12.11)),no=Hi||Ri&&Bi>=9,io=function(t,r){var n=t.className,i=e(r).exec(n)
if(i){var o=n.slice(i.index+i[0].length)
t.className=n.slice(0,i.index)+(o?i[1]+o:"")}}
to=document.createRange?function(e,t,r,n){var i=document.createRange()
...
var oo=function(e){e.select()}
_i?oo=function(e){e.selectionStart=0,e.selectionEnd=e.value.length}:Ri&&(oo=function(e){try{e.select()}catch(e){}})
var ao=function(){this.id=null}
ao.prototype.set=function(e,t){clearTimeout(this.id),this.id=setTimeout(t,e)}
var lo,so,uo=30,co={toString:function(){return"CodeMirror.Pass"}},fo={scroll:!1},ho={origin:"*mouse"},po={origin:"+move"},go=[""],mo=/[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,vo=/[\u0300-\u036f\u0483-\u0489\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u064b-\u065e\u0670\u06d6-\u06dc\u06de-\u06e4\u06e7\u06e8\u06ea-\u06ed\u0711\u0730-\u074a\u07a6-\u07b0\u07eb-\u07f3\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0900-\u0902\u093c\u0941-\u0948\u094d\u0951-\u0955\u0962\u0963\u0981\u09bc\u09be\u09c1-\u09c4\u09cd\u09d7\u09e2\u09e3\u0a01\u0a02\u0a3c\u0a41\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a70\u0a71\u0a75\u0a81\u0a82\u0abc\u0ac1-\u0ac5\u0ac7\u0ac8\u0acd\u0ae2\u0ae3\u0b01\u0b3c\u0b3e\u0b3f\u0b41-\u0b44\u0b4d\u0b56\u0b57\u0b62\u0b63\u0b82\u0bbe\u0bc0\u0bcd\u0bd7\u0c3e-\u0c40\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62\u0c63\u0cbc\u0cbf\u0cc2\u0cc6\u0ccc\u0ccd\u0cd5\u0cd6\u0ce2\u0ce3\u0d3e\u0d41-\u0d44\u0d4d\u0d57\u0d62\u0d63\u0dca\u0dcf\u0dd2-\u0dd4\u0dd6\u0ddf\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0eb1\u0eb4-\u0eb9\u0ebb\u0ebc\u0ec8-\u0ecd\u0f18\u0f19\u0f35\u0f37\u0f39\u0f71-\u0f7e\u0f80-\u0f84\u0f86\u0f87\u0f90-\u0f97\u0f99-\u0fbc\u0fc6\u102d-\u1030\u1032-\u1037\u1039\u103a\u103d\u103e\u1058\u1059\u105e-\u1060\u1071-\u1074\u1082\u1085\u1086\u108d\u109d\u135f\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17b7-\u17bd\u17c6\u17c9-\u17d3\u17dd\u180b-\u180d\u18a9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193b\u1a17\u1a18\u1a56\u1a58-\u1a5e\u1a60\u1a62\u1a65-\u1a6c\u1a73-\u1a7c\u1a7f\u1b00-\u1b03\u1b34\u1b36-\u1b3a\u1b3c\u1b42\u1b6b-\u1b73\u1b80\u1b81\u1ba2-\u1ba5\u1ba8\u1ba9\u1c2c-\u1c33\u1c36\u1c37\u1cd0-\u1cd2\u1cd4-\u1ce0\u1ce2-\u1ce8\u1ced\u1dc0-\u1de6\u1dfd-\u1dff\u200c\u200d\u20d0-\u20f0\u2cef-\u2cf1\u2de0-\u2dff\u302a-\u302f\u3099\u309a\ua66f-\ua672\ua67c\ua67d\ua6f0\ua6f1\ua802\ua806\ua80b\ua825\ua826\ua8c4\ua8e0-\ua8f1\ua926-\ua92d\ua947-\ua951\ua980-\ua982\ua9b3\ua9b6-\ua9b9\ua9bc\uaa29-\uaa2e\uaa31\uaa32\uaa35\uaa36\uaa43\uaa4c\uaab0\uaab2-\uaab4\uaab7\uaab8\uaabe\uaabf\uaac1\uabe5\uabe8\uabed\udc00-\udfff\ufb1e\ufe00-\ufe0f\ufe20-\ufe26\uff9e\uff9f]/,yo=!1,bo=!1,wo=null,xo=function(){function e(e){return e<=247?r.charAt(e):1424<=e&&e<=1524?"R":1536<=e&&e<=1785?n.charAt(e-1536):1774<=e&&e<=2220?"r":8192<=e&&e<=8203?"w":8204==e?"b":"L"}function t(e,t,r){this.level=e,this.from=t,this.to=r}var r="bbbbbbbbbtstwsbbbbbbbbbbbbbbssstwNN%%%NNNNNN,N,N1111111111NNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNbbbbbbsbbbbbbbbbbbbbbbbbbbbbbbbbb,N%%%%NNNNLNNNNN%%11NLNNN1LNNNNNLLLLLLLLLLLLLLLLLLLLLLLNLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLN",n="nnnnnnNNr%%r,rNNmmmmmmmmmmmrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrmmmmmmmmmmmmmmmmmmmmmnnnnnnnnnn%nnrrrmrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrmmmmmmmnNmmmmmmrrmmNmmmmrr1111111111",i=/[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/,o=/[stwN]/,a=/[LRr]/,l=/[Lb1n]/,s=/[1n]/
...
B<F&&I.splice(j,0,new t(1,B,F))}return"ltr"==n&&(1==I[0].level&&(E=r.match(/^\s+/))&&(I[0].from=E[0].length,I.unshift(new t(0,0,E[0].length))),1==g(I).level&&(E=r.match(/\s+$/))&&(g(I).to-=E[0].length,I.push(new t(0,c-E[0].length,c)))),"rtl"==n?I.reverse():I}}(),ko=[],Co=function(e,t,r){if(e.addEventListener)e.addEventListener(t,r,!1)
else if(e.attachEvent)e.attachEvent("on"+t,r)
else{var n=e._handlers||(e._handlers={})
n[t]=(n[t]||ko).concat(r)}},So=function(){if(Ri&&Bi<9)return!1
var e=n("div")
return"draggable"in e||"dragDrop"in e}(),Lo=3!="\n\nb".split(/\n/).length?function(e){for(var t=0,r=[],n=e.length;t<=n;){var i=e.indexOf("\n",t);-1==i&&(i=e.length)
var o=e.slice(t,"\r"==e.charAt(i-1)?i-1:i),a=o.indexOf("\r");-1!=a?(r.push(o.slice(0,a)),t+=a+1):(r.push(o),t=i+1)}return r}:function(e){return e.split(/\r\n?|\n/)},To=window.getSelection?function(e){try{return e.selectionStart!=e.selectionEnd}catch(e){return!1}}:function(e){var t
try{t=e.ownerDocument.selection.createRange()}catch(e){}return!(!t||t.parentElement()!=e)&&0!=t.compareEndPoints("StartToEnd",t)},Mo=function(){var e=n("div")
return"oncopy"in e||(e.setAttribute("oncopy","return;"),"function"==typeof e.oncopy)}(),No=null,Ao={},Oo={},Wo={},zo=function(e,t,r){this.pos=this.start=0,this.string=e,this.tabSize=t||8,this.lastColumnPos=this.lastColumnValue=0,this.lineStart=0,this.lineOracle=r}
...
if("string"==typeof e?t==e:t&&(e.test?e.test(t):e(t)))return++this.pos,t},zo.prototype.eatWhile=function(e){for(var t=this.pos;this.eat(e););return this.pos>t},zo.prototype.eatSpace=function(){for(var e=this,t=this.pos;/[\s\u00a0]/.test(this.string.charAt(this.pos));)++e.pos
return this.pos>t},zo.prototype.skipToEnd=function(){this.pos=this.string.length},zo.prototype.skipTo=function(e){var t=this.string.indexOf(e,this.pos)
if(t>-1)return this.pos=t,!0},zo.prototype.backUp=function(e){this.pos-=e},zo.prototype.column=function(){return this.lastColumnPos<this.start&&(this.lastColumnValue=d(this.string,this.start,this.tabSize,this.lastColumnPos,this.lastColumnValue),this.lastColumnPos=this.start),this.lastColumnValue-(this.lineStart?d(this.string,this.lineStart,this.tabSize):0)},zo.prototype.indentation=function(){return d(this.string,null,this.tabSize)-(this.lineStart?d(this.string,this.lineStart,this.tabSize):0)},zo.prototype.match=function(e,t,r){if("string"!=typeof e){var n=this.string.slice(this.pos).match(e)
return n&&n.index>0?null:(n&&!1!==t&&(this.pos+=n[0].length),n)}var i=function(e){return r?e.toLowerCase():e}
if(i(this.string.substr(this.pos,e.length))==i(e))return!1!==t&&(this.pos+=e.length),!0},zo.prototype.current=function(){return this.string.slice(this.start,this.pos)},zo.prototype.hideFirstChars=function(e,t){this.lineStart+=e
try{return t()}finally{this.lineStart-=e}},zo.prototype.lookAhead=function(e){var t=this.lineOracle
return t&&t.lookAhead(e)},zo.prototype.baseToken=function(){var e=this.lineOracle
return e&&e.baseToken(this.pos)}
var Do=function(e,t){this.state=e,this.lookAhead=t},Po=function(e,t,r,n){this.state=t,this.doc=e,this.line=r,this.maxLookAhead=n||0,this.baseTokens=null,this.baseTokenPos=1}
Po.prototype.lookAhead=function(e){var t=this.doc.getLine(this.line+e)
return null!=t&&e>this.maxLookAhead&&(this.maxLookAhead=e),t},Po.prototype.baseToken=function(e){var t=this
if(!this.baseTokens)return null
for(;this.baseTokens[this.baseTokenPos]<=e;)t.baseTokenPos+=2
var r=this.baseTokens[this.baseTokenPos+1]
return{type:r&&r.replace(/( |^)overlay .*/,""),size:this.baseTokens[this.baseTokenPos]-e}},Po.prototype.nextLine=function(){this.line++,this.maxLookAhead>0&&this.maxLookAhead--},Po.fromSaved=function(e,t,r){return t instanceof Do?new Po(e,Oe(e.mode,t.state),r,t.lookAhead):new Po(e,Oe(e.mode,t),r)},Po.prototype.save=function(e){var t=!1!==e?Oe(this.doc.mode,this.state):this.state
return this.maxLookAhead>0?new Do(t,this.maxLookAhead):t}
var Ho=function(e,t,r){this.start=e.start,this.end=e.pos,this.string=e.current(),this.type=t||null,this.state=r},Eo=function(e,t,r){this.text=e,_(this,t),this.height=r?r(this):1}
Eo.prototype.lineNo=function(){return A(this)},ye(Eo)
var Io,Fo={},Ro={},Bo=null,jo=null,Vo={left:0,right:0,top:0,bottom:0},Ko=function(e,t,r){this.cm=r
...
e(i),e(o),Co(i,"scroll",function(){i.clientHeight&&t(i.scrollTop,"vertical")}),Co(o,"scroll",function(){o.clientWidth&&t(o.scrollLeft,"horizontal")}),this.checkedZeroWidth=!1,Ri&&Bi<8&&(this.horiz.style.minHeight=this.vert.style.minWidth="18px")}
Ko.prototype.update=function(e){var t=e.scrollWidth>e.clientWidth+1,r=e.scrollHeight>e.clientHeight+1,n=e.nativeBarWidth
...
return!this.checkedZeroWidth&&e.clientHeight>0&&(0==n&&this.zeroWidthHack(),this.checkedZeroWidth=!0),{right:r?n:0,bottom:t?n:0}},Ko.prototype.setScrollLeft=function(e){this.horiz.scrollLeft!=e&&(this.horiz.scrollLeft=e),this.disableHoriz&&this.enableZeroWidthBar(this.horiz,this.disableHoriz,"horiz")},Ko.prototype.setScrollTop=function(e){this.vert.scrollTop!=e&&(this.vert.scrollTop=e),this.disableVert&&this.enableZeroWidthBar(this.vert,this.disableVert,"vert")},Ko.prototype.zeroWidthHack=function(){var e=Zi&&!qi?"12px":"18px"
this.horiz.style.height=this.vert.style.width=e,this.horiz.style.pointerEvents=this.vert.style.pointerEvents="none",this.disableHoriz=new ao,this.disableVert=new ao},Ko.prototype.enableZeroWidthBar=function(e,t,r){function n(){var i=e.getBoundingClientRect();("vert"==r?document.elementFromPoint(i.right-1,(i.top+i.bottom)/2):document.elementFromPoint((i.right+i.left)/2,i.bottom-1))!=e?e.style.pointerEvents="none":t.set(1e3,n)}e.style.pointerEvents="auto",t.set(1e3,n)},Ko.prototype.clear=function(){var e=this.horiz.parentNode
e.removeChild(this.horiz),e.removeChild(this.vert)}
var Go=function(){}
Go.prototype.update=function(){return{bottom:0,right:0}},Go.prototype.setScrollLeft=function(){},Go.prototype.setScrollTop=function(){},Go.prototype.clear=function(){}
var Uo={native:Ko,null:Go},qo=0,$o=function(e,t,r){var n=e.display
...
$o.prototype.signal=function(e,t){ve(e,t)&&this.events.push(arguments)},$o.prototype.finish=function(){for(var e=this,t=0;t<this.events.length;t++)pe.apply(null,e.events[t])}
var _o=0,Xo=null
Ri?Xo=-.53:Hi?Xo=15:Ki?Xo=-.7:Ui&&(Xo=-1/3)
var Yo=function(e,t){this.ranges=e,this.primIndex=t}
Yo.prototype.primary=function(){return this.ranges[this.primIndex]},Yo.prototype.equals=function(e){var t=this
if(e==this)return!0
if(e.primIndex!=this.primIndex||e.ranges.length!=this.ranges.length)return!1
for(var r=0;r<this.ranges.length;r++){var n=t.ranges[r],i=e.ranges[r]
if(!H(n.anchor,i.anchor)||!H(n.head,i.head))return!1}return!0},Yo.prototype.deepCopy=function(){for(var e=this,t=[],r=0;r<this.ranges.length;r++)t[r]=new Zo(E(e.ranges[r].anchor),E(e.ranges[r].head))
return new Yo(t,this.primIndex)},Yo.prototype.somethingSelected=function(){for(var e=this,t=0;t<this.ranges.length;t++)if(!e.ranges[t].empty())return!0
return!1},Yo.prototype.contains=function(e,t){var r=this
t||(t=e)
...
if(0==(t-=l))break
e=0}else e-=a}}}
var Qo=function(e,t,r){var n=this
if(r)for(var i in r)r.hasOwnProperty(i)&&(n[i]=r[i])
this.doc=e,this.node=t}
Qo.prototype.clear=function(){var e=this,t=this.doc.cm,r=this.line.widgets,n=this.line,i=A(n)
if(null!=i&&r){for(var o=0;o<r.length;++o)r[o]==e&&r.splice(o--,1)
r.length||(n.widgets=null)
var a=at(this)
N(n,Math.max(0,n.height-a)),t&&(br(t,function(){In(t,n,-a),Sr(t,i,"widget")}),Ye(t,"lineWidgetCleared",t,this,i))}},Qo.prototype.changed=function(){var e=this,t=this.height,r=this.doc.cm,n=this.line
this.height=null
var i=at(this)-t
i&&(N(n,n.height+i),r&&br(r,function(){r.curOp.forceUpdate=!0,In(r,n,i),Ye(r,"lineWidgetChanged",r,e,A(n))}))},ye(Qo)
var Jo=0,ea=function(e,t){this.lines=[],this.type=t,this.doc=e,this.id=++Jo}
ea.prototype.clear=function(){var e=this
...
d>t.display.maxLineLength&&(t.display.maxLine=c,t.display.maxLineLength=d,t.display.maxLineChanged=!0)}null!=i&&t&&this.collapsed&&Cr(t,i,o+1),this.lines.length=0,this.explicitlyCleared=!0,this.atomic&&this.doc.cantEdit&&(this.doc.cantEdit=!1,t&&yn(t.doc)),t&&Ye(t,"markerCleared",t,this,i,o),r&&yr(t),this.parent&&this.parent.clear()}},ea.prototype.find=function(e,t){var r=this
...
if(null!=l.to&&(i=D(t?a:A(a),l.to),1==e))return i}return n&&{from:n,to:i}},ea.prototype.changed=function(){var e=this,t=this.find(-1,!0),r=this,n=this.doc.cm
...
r.height=null
var s=at(r)-l
s&&N(i,i.height+s)}Ye(n,"markerChanged",n,e)})},ea.prototype.attachLine=function(e){if(!this.lines.length&&this.doc.cm){var t=this.doc.cm.curOp
t.maybeHiddenMarkers&&-1!=f(t.maybeHiddenMarkers,this)||(t.maybeUnhiddenMarkers||(t.maybeUnhiddenMarkers=[])).push(this)}this.lines.push(e)},ea.prototype.detachLine=function(e){if(this.lines.splice(f(this.lines,e),1),!this.lines.length&&this.doc.cm){var t=this.doc.cm.curOp;(t.maybeHiddenMarkers||(t.maybeHiddenMarkers=[])).push(this)}},ye(ea)
var ta=function(e,t){var r=this
...
Ye(this,"clear")}},ta.prototype.find=function(e,t){return this.primary.find(e,t)},ye(ta)
var ra=0,na=function(e,t,r,n,i){if(!(this instanceof na))return new na(e,t,r,n,i)
null==r&&(r=0),En.call(this,[new Hn([new Eo("",null)])]),this.first=r,this.scrollTop=this.scrollLeft=0,this.cantEdit=!1,this.cleanGeneration=1,this.modeFrontier=this.highlightFrontier=r
var o=D(r,0)
this.sel=jr(o),this.history=new Jr(null),this.id=++ra,this.modeOption=t,this.lineSep=n,this.direction="rtl"==i?"rtl":"ltr",this.extend=!1,"string"==typeof e&&(e=this.splitLines(e)),Xr(this,{from:o,to:o,text:e}),gn(this,jr(o),fo)}
na.prototype=y(En.prototype,{constructor:na,iter:function(e,t,r){r?this.iterN(e-this.first,t-e,r):this.iterN(this.first,this.first+this.size,e)},insert:function(e,t){for(var r=0,n=0;n<t.length;++n)r+=t[n].height
...
Ln(this,{from:t,to:D(r,L(this,r).text.length),text:this.splitLines(e),origin:"setValue",full:!0},!0),this.cm&&lr(this.cm,0,0),gn(this,jr(t),fo)}),replaceRange:function(e,t,r,n){On(this,e,t=B(this,t),r=r?B(this,r):t,n)},getRange:function(e,t,r){var n=T(this,B(this,e),B(this,t))
...
n.push(new Zo(B(this,e),B(this,t||e))),gn(this,Br(n,n.length-1),r)}),getSelection:function(e){for(var t,r=this,n=this.sel.ranges,i=0;i<n.length;i++){var o=T(r,n[i].from(),n[i].to())
...
n[a]=new Zo(d?u:s,d?s:u)}else n[a]=new Zo(s,s)}return new Yo(n,e.sel.primIndex)}(this,i,t),u=i.length-1;u>=0;u--)Ln(n,i[u])
...
t[i]=o.slice(0,a.index)+(a.index&&l!=o.length?" ":"")+o.slice(l)||null}return!0})}),addLineWidget:kr(function(e,t,r){return function(e,t,r,n){var i=new Qo(e,r,n),o=e.cm
...
return this.iter(this.first,e.line,function(e){t+=e.text.length+r}),t},copy:function(e){var t=new na(M(this,this.first,this.first+this.size),this.modeOption,this.first,this.lineSep,this.direction)
...
var n=new na(M(this,t,r),e.mode||this.modeOption,t,this.lineSep,this.direction)
...
return e.coordsChar({left:e.display.lineDiv.offsetWidth+100,top:r},"div")},po)},goLineLeft:function(e){return e.extendSelectionsBy(function(t){var r=e.cursorCoords(t.head,"div").top+5
return e.coordsChar({left:0,top:r},"div")},po)},goLineLeftSmart:function(e){return e.extendSelectionsBy(function(t){var r=e.cursorCoords(t.head,"div").top+5,n=e.coordsChar({left:0,top:r},"div")
return n.ch<e.getLine(n.line).search(/\S/)?ni(e,t.head):n},po)},goLineUp:function(e){return e.moveV(-1,"line")},goLineDown:function(e){return e.moveV(1,"line")},goPageUp:function(e){return e.moveV(-1,"page")},goPageDown:function(e){return e.moveV(1,"page")},goCharLeft:function(e){return e.moveH(-1,"char")},goCharRight:function(e){return e.moveH(1,"char")},goColumnLeft:function(e){return e.moveH(-1,"column")},goColumnRight:function(e){return e.moveH(1,"column")},goWordLeft:function(e){return e.moveH(-1,"word")},goGroupRight:function(e){return e.moveH(1,"group")},goGroupLeft:function(e){return e.moveH(-1,"group")},goWordRight:function(e){return e.moveH(1,"word")},delCharBefore:function(e){return e.deleteH(-1,"char")},delCharAfter:function(e){return e.deleteH(1,"char")},delWordBefore:function(e){return e.deleteH(-1,"word")},delWordAfter:function(e){return e.deleteH(1,"word")},delGroupBefore:function(e){return e.deleteH(-1,"group")},delGroupAfter:function(e){return e.deleteH(1,"group")},indentAuto:function(e){return e.indentSelection("smart")},indentMore:function(e){return e.indentSelection("add")},indentLess:function(e){return e.indentSelection("subtract")},insertTab:function(e){return e.replaceSelection("\t")},insertSoftTab:function(e){for(var t=[],r=e.listSelections(),n=e.options.tabSize,i=0;i<r.length;i++){var o=r[i].from(),a=d(e.getLine(o.line),o.ch,n)
...
a&&(i=new D(i.line,1),e.replaceRange(o.charAt(0)+e.doc.lineSeparator()+a.charAt(a.length-1),D(i.line-1,a.length-1),i,"+transpose"))}r.push(new Zo(i,i))}e.setSelections(r)})},newlineAndIndent:function(e){return br(e,function(){for(var t=e.listSelections(),r=t.length-1;r>=0;r--)e.replaceRange(e.doc.lineSeparator(),t[r].anchor,t[r].head,"+input")
t=e.listSelections()
for(var n=0;n<t.length;n++)e.indentLine(t[n].from().line,null,!0)
ar(e)})},openLine:function(e){return e.replaceSelection("\n","start")},toggleOverwrite:function(e){return e.toggleOverwrite()}},fa=new ao,ha=null,pa=function(e,t,r){this.time=e,this.pos=t,this.button=r}
pa.prototype.compare=function(e,t,r){return this.time+400>e&&0==P(t,this.pos)&&r==this.button}
var ga,ma,va={toString:function(){return"CodeMirror.Init"}},ya={},ba={}
bi.defaults=ya,bi.optionHandlers=ba
var wa=[]
bi.defineInitHook=function(e){return wa.push(e)}
var xa=null,ka=function(e){this.cm=e,this.lastAnchorNode=this.lastAnchorOffset=this.lastFocusNode=this.lastFocusOffset=null,this.polling=new ao,this.composing=null,this.gracePeriod=!1,this.readDOMTimeout=null}
ka.prototype.init=function(e){function t(e){if(!ge(i,e)){if(i.somethingSelected())xi({lineWise:!1,text:i.getSelections()}),"cut"==e.type&&i.replaceSelection("",null,"cut")
else{if(!i.options.lineWiseCopyCut)return
var t=Li(i)
xi({lineWise:!0,text:t.text}),"cut"==e.type&&i.operation(function(){i.setSelections(t.ranges,0,fo),i.replaceSelection("",null,"cut")})}if(e.clipboardData){e.clipboardData.clearData()
var r=xa.text.join("\n")
if(e.clipboardData.setData("Text",r),e.clipboardData.getData("Text")==r)return void e.preventDefault()}var a=Mi(),l=a.firstChild
i.display.lineSpace.insertBefore(a,i.display.lineSpace.firstChild),l.value=xa.text.join("\n")
var s=document.activeElement
oo(l),setTimeout(function(){i.display.lineSpace.removeChild(a),s.focus(),s==o&&n.showPrimarySelection()},50)}}var r=this,n=this,i=n.cm,o=n.div=e.lineDiv
Ti(o,i.options.spellcheck),Co(o,"paste",function(e){ge(i,e)||Ci(e,i)||Bi<=11&&setTimeout(wr(i,function(){return r.updateFromDOM()}),20)}),Co(o,"compositionstart",function(e){r.composing={data:e.data,done:!1}}),Co(o,"compositionupdate",function(e){r.composing||(r.composing={data:e.data,done:!1})}),Co(o,"compositionend",function(e){r.composing&&(e.data!=r.composing.data&&r.readFromDOMSoon(),r.composing.done=!0)}),Co(o,"touchstart",function(){return n.forceCompositionEnd()}),Co(o,"input",function(){r.composing||r.readFromDOMSoon()}),Co(o,"copy",t),Co(o,"cut",t)},ka.prototype.prepareSelection=function(){var e=Ut(this.cm,!1)
return e.focus=this.cm.state.focused,e},ka.prototype.showSelection=function(e,t){e&&this.cm.display.view.length&&((e.focus||t)&&this.showPrimarySelection(),this.showMultipleSelections(e))},ka.prototype.showPrimarySelection=function(){var e=window.getSelection(),t=this.cm,r=t.doc.sel.primary(),n=r.from(),i=r.to()
if(t.display.viewTo==t.display.viewFrom||n.line>=t.display.viewTo||i.line<t.display.viewFrom)e.removeAllRanges()
else{var o=zi(t,e.anchorNode,e.anchorOffset),a=zi(t,e.focusNode,e.focusOffset)
if(!o||o.bad||!a||a.bad||0!=P(F(o,a),n)||0!=P(I(o,a),i)){var l=t.display.view,s=n.line>=t.display.viewFrom&&Oi(t,n)||{node:l[0].measure.map[2],offset:0},u=i.line<t.display.viewTo&&Oi(t,i)
...
try{f=to(s.node,s.offset,u.offset,u.node)}catch(e){}f&&(!Hi&&t.state.focused?(e.collapse(s.node,s.offset),f.collapsed||(e.removeAllRanges(),e.addRange(f))):(e.removeAllRanges(),e.addRange(f)),h&&null==e.anchorNode?e.addRange(h):Hi&&this.startGracePeriod()),this.rememberSelection()}else e.removeAllRanges()}}},ka.prototype.startGracePeriod=function(){var e=this
clearTimeout(this.gracePeriod),this.gracePeriod=setTimeout(function(){e.gracePeriod=!1,e.selectionChanged()&&e.cm.operation(function(){return e.cm.curOp.selectionChanged=!0})},20)},ka.prototype.showMultipleSelections=function(e){r(this.cm.display.cursorDiv,e.cursors),r(this.cm.display.selectionDiv,e.selection)},ka.prototype.rememberSelection=function(){var e=window.getSelection()
this.lastAnchorNode=e.anchorNode,this.lastAnchorOffset=e.anchorOffset,this.lastFocusNode=e.focusNode,this.lastFocusOffset=e.focusOffset},ka.prototype.selectionInEditor=function(){var e=window.getSelection()
if(!e.rangeCount)return!1
var t=e.getRangeAt(0).commonAncestorContainer
return o(this.div,t)},ka.prototype.focus=function(){"nocursor"!=this.cm.options.readOnly&&(this.selectionInEditor()||this.showSelection(this.prepareSelection(),!0),this.div.focus())},ka.prototype.blur=function(){this.div.blur()},ka.prototype.getField=function(){return this.div},ka.prototype.supportsTouch=function(){return!0},ka.prototype.receivedFocus=function(){function e(){t.cm.state.focused&&(t.pollSelection(),t.polling.set(t.cm.options.pollInterval,e))}var t=this
this.selectionInEditor()?this.pollSelection():br(this.cm,function(){return t.cm.curOp.selectionChanged=!0}),this.polling.set(this.cm.options.pollInterval,e)},ka.prototype.selectionChanged=function(){var e=window.getSelection()
return e.anchorNode!=this.lastAnchorNode||e.anchorOffset!=this.lastAnchorOffset||e.focusNode!=this.lastFocusNode||e.focusOffset!=this.lastFocusOffset},ka.prototype.pollSelection=function(){if(null==this.readDOMTimeout&&!this.gracePeriod&&this.selectionChanged()){var e=window.getSelection(),t=this.cm
if(Xi&&Ki&&this.cm.options.gutters.length&&function(e){for(var t=e;t;t=t.parentNode)if(/CodeMirror-gutter-wrapper/.test(t.className))return!0
...
var r=zi(t,e.anchorNode,e.anchorOffset),n=zi(t,e.focusNode,e.focusOffset)
r&&n&&br(t,function(){gn(t.doc,jr(r,n),fo),(r.bad||n.bad)&&(t.curOp.selectionChanged=!0)})}}},ka.prototype.pollContent=function(){null!=this.readDOMTimeout&&(clearTimeout(this.readDOMTimeout),this.readDOMTimeout=null)
...
!this.cm.isReadOnly()&&this.pollContent()||br(this.cm,function(){return Cr(e.cm)})},ka.prototype.setUneditable=function(e){e.contentEditable="false"},ka.prototype.onKeyPress=function(e){0!=e.charCode&&(e.preventDefault(),this.cm.isReadOnly()||wr(this.cm,ki)(this.cm,String.fromCharCode(null==e.charCode?e.keyCode:e.charCode),0))},ka.prototype.readOnlyChanged=function(e){this.div.contentEditable=String("nocursor"!=e)},ka.prototype.onContextMenu=function(){},ka.prototype.resetPosition=function(){},ka.prototype.needsContentAttribute=!0
var Ca=function(e){this.cm=e,this.prevInput="",this.pollingFast=!1,this.polling=new ao,this.hasSelection=!1,this.composing=null}
Ca.prototype.init=function(e){function t(e){if(!ge(i,e)){if(i.somethingSelected())xi({lineWise:!1,text:i.getSelections()})
else{if(!i.options.lineWiseCopyCut)return
var t=Li(i)
xi({lineWise:!0,text:t.text}),"cut"==e.type?i.setSelections(t.ranges,null,fo):(n.prevInput="",a.value=t.text.join("\n"),oo(a))}"cut"==e.type&&(i.state.cutIncoming=!0)}}var r=this,n=this,i=this.cm,o=this.wrapper=Mi(),a=this.textarea=o.firstChild
e.wrapper.insertBefore(o,e.wrapper.firstChild),_i&&(a.style.width="0px"),Co(a,"input",function(){Ri&&Bi>=9&&r.hasSelection&&(r.hasSelection=null),n.poll()}),Co(a,"paste",function(e){ge(i,e)||Ci(e,i)||(i.state.pasteIncoming=!0,n.fastPoll())}),Co(a,"cut",t),Co(a,"copy",t),Co(e.scroller,"paste",function(t){lt(e,t)||ge(i,t)||(i.state.pasteIncoming=!0,n.focus())}),Co(e.lineSpace,"selectstart",function(t){lt(e,t)||be(t)}),Co(a,"compositionstart",function(){var e=i.getCursor("from")
n.composing&&n.composing.range.clear(),n.composing={start:e,range:i.markText(e,i.getCursor("to"),{className:"CodeMirror-composing"})}}),Co(a,"compositionend",function(){n.composing&&(n.poll(),n.composing.range.clear(),n.composing=null)})},Ca.prototype.prepareSelection=function(){var e=this.cm,t=e.display,r=e.doc,n=Ut(e)
...
n.teTop=Math.max(0,Math.min(t.wrapper.clientHeight-10,i.top+a.top-o.top)),n.teLeft=Math.max(0,Math.min(t.wrapper.clientWidth-10,i.left+a.left-o.left))}return n},Ca.prototype.showSelection=function(e){var t=this.cm.display
r(t.cursorDiv,e.cursors),r(t.selectionDiv,e.selection),null!=e.teTop&&(this.wrapper.style.top=e.teTop+"px",this.wrapper.style.left=e.teLeft+"px")},Ca.prototype.reset=function(e){if(!this.contextMenuPending&&!this.composing){var t=this.cm
if(t.somethingSelected()){this.prevInput=""
var r=t.getSelection()
this.textarea.value=r,t.state.focused&&oo(this.textarea),Ri&&Bi>=9&&(this.hasSelection=r)}else e||(this.prevInput=this.textarea.value="",Ri&&Bi>=9&&(this.hasSelection=null))}},Ca.prototype.getField=function(){return this.textarea},Ca.prototype.supportsTouch=function(){return!1},Ca.prototype.focus=function(){if("nocursor"!=this.cm.options.readOnly&&(!Yi||a()!=this.textarea))try{this.textarea.focus()}catch(e){}},Ca.prototype.blur=function(){this.textarea.blur()},Ca.prototype.resetPosition=function(){this.wrapper.style.top=this.wrapper.style.left=0},Ca.prototype.receivedFocus=function(){this.slowPoll()},Ca.prototype.slowPoll=function(){var e=this
this.pollingFast||this.polling.set(this.cm.options.pollInterval,function(){e.poll(),e.cm.state.focused&&e.slowPoll()})},Ca.prototype.fastPoll=function(){function e(){r.poll()||t?(r.pollingFast=!1,r.slowPoll()):(t=!0,r.polling.set(60,e))}var t=!1,r=this
r.pollingFast=!0,r.polling.set(20,e)},Ca.prototype.poll=function(){var e=this,t=this.cm,r=this.textarea,n=this.prevInput
if(this.contextMenuPending||!t.state.focused||To(r)&&!n&&!this.composing||t.isReadOnly()||t.options.disableInput||t.state.keySeq)return!1
var i=r.value
if(i==n&&!t.somethingSelected())return!1
if(Ri&&Bi>=9&&this.hasSelection===i||Zi&&/[\uf700-\uf7ff]/.test(i))return t.display.input.reset(),!1
...
return br(t,function(){ki(t,i.slice(a),n.length-a,null,e.composing?"*compose":null),i.length>1e3||i.indexOf("\n")>-1?r.value=e.prevInput="":e.prevInput=i,e.composing&&(e.composing.range.clear(),e.composing.range=t.markText(e.composing.start,t.getCursor("to"),{className:"CodeMirror-composing"}))}),!0},Ca.prototype.ensurePolled=function(){this.pollingFast&&this.poll()&&(this.pollingFast=!1)},Ca.prototype.onKeyPress=function(){Ri&&Bi>=9&&(this.hasSelection=null),this.fastPoll()},Ca.prototype.onContextMenu=function(e){function t(){if(null!=a.selectionStart){var e=i.somethingSelected(),t="​"+(e?a.value:"")
a.value="⇚",a.value=t,n.prevInput=e?"":"​",a.selectionStart=1,a.selectionEnd=t.length,o.selForContextMenu=i.doc.sel}}function r(){if(n.contextMenuPending=!1,n.wrapper.style.cssText=c,a.style.cssText=u,Ri&&Bi<9&&o.scrollbars.setScrollTop(o.scroller.scrollTop=s),null!=a.selectionStart){(!Ri||Ri&&Bi<9)&&t()
...
if(l&&!Gi){i.options.resetSelectionOnContextMenu&&-1==i.doc.sel.contains(l)&&wr(i,gn)(i.doc,jr(l),fo)
...
var f
if(ji&&(f=window.scrollY),o.input.focus(),ji&&window.scrollTo(null,f),o.input.reset(),i.somethingSelected()||(a.value=n.prevInput=" "),n.contextMenuPending=!0,o.selForContextMenu=i.doc.sel,clearTimeout(o.detectingSelectAll),Ri&&Bi>=9&&t(),no){ke(e)
var h=function(){he(window,"mouseup",h),setTimeout(r,20)}
Co(window,"mouseup",h)}else setTimeout(r,50)}},Ca.prototype.readOnlyChanged=function(e){e||this.reset(),this.textarea.disabled="nocursor"==e},Ca.prototype.setUneditable=function(){},Ca.prototype.needsContentAttribute=!1,function(e){function t(t,n,i,o){e.defaults[t]=n,i&&(r[t]=o?function(e,t,r){r!=va&&i(e,t,r)}:i)}var r=e.optionHandlers
e.defineOption=t,e.Init=va,t("value","",function(e,t){return e.setValue(t)},!0),t("mode",null,function(e,t){e.doc.modeOption=t,qr(e)},!0),t("indentUnit",2,qr,!0),t("indentWithTabs",!1),t("smartIndent",!0),t("tabSize",4,function(e){$r(e),kt(e),Cr(e)},!0),t("lineSeparator",null,function(e,t){if(e.doc.lineSep=t,t){var r=[],n=e.doc.first
e.doc.iter(function(e){for(var i=0;;){var o=e.text.indexOf(t,i)
if(-1==o)break
i=o+t.length,r.push(D(n,o))}n++})
for(var i=r.length-1;i>=0;i--)On(e.doc,t,r[i],D(r[i].line,r[i].ch+t.length))}}),t("specialChars",/[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b-\u200f\u2028\u2029\ufeff]/g,function(e,t,r){e.state.specialChars=new RegExp(t.source+(t.test("\t")?"":"|\t"),"g"),r!=va&&e.refresh()}),t("specialCharPlaceholder",Ue,function(e){return e.refresh()},!0),t("electricChars",!0),t("inputStyle",Yi?"contenteditable":"textarea",function(){throw new Error("inputStyle can not (yet) be changed in a running editor")},!0),t("spellcheck",!1,function(e,t){return e.getInputField().spellcheck=t},!0),t("rtlMoveVisually",!Ji),t("wholeLineUpdateBefore",!0),t("theme","default",function(e){gi(e),mi(e)},!0),t("keyMap","default",function(e,t,r){var n=Zn(t),i=r!=va&&Zn(r)
i&&i.detach&&i.detach(e,n),n.attach&&n.attach(e,i||null)}),t("extraKeys",null),t("configureMouse",null),t("lineWrapping",!1,yi,!0),t("gutters",[],function(e){Er(e.options),mi(e)},!0),t("fixedGutter",!0,function(e,t){e.display.gutters.style.left=t?Rt(e.display)+"px":"0",e.refresh()},!0),t("coverGutterNextToScrollbar",!1,function(e){return pr(e)},!0),t("scrollbarStyle","native",function(e){mr(e),pr(e),e.display.scrollbars.setScrollTop(e.doc.scrollTop),e.display.scrollbars.setScrollLeft(e.doc.scrollLeft)},!0),t("lineNumbers",!1,function(e){Er(e.options),mi(e)},!0),t("firstLineNumber",1,mi,!0),t("lineNumberFormatter",function(e){return e},mi,!0),t("showCursorWhenSelecting",!1,Gt,!0),t("resetSelectionOnContextMenu",!0),t("lineWiseCopyCut",!0),t("pasteLinesPerSelection",!0),t("readOnly",!1,function(e,t){"nocursor"==t&&(Qt(e),e.display.input.blur()),e.display.input.readOnlyChanged(t)}),t("disableInput",!1,function(e,t){t||e.display.input.reset()},!0),t("dragDrop",!0,vi),t("allowDropFileTypes",null),t("cursorBlinkRate",530),t("cursorScrollMargin",0),t("cursorHeight",1,Gt,!0),t("singleCursorHeightPerLine",!0,Gt,!0),t("workTime",100),t("workDelay",100),t("flattenSpans",!0,$r,!0),t("addModeClass",!1,$r,!0),t("pollInterval",100),t("undoDepth",200,function(e,t){return e.doc.history.undoDepth=t}),t("historyEventDelay",1250),t("viewportMargin",10,function(e){return e.refresh()},!0),t("maxHighlightLength",1e4,$r,!0),t("moveInputWithCursor",!0,function(e,t){t||e.display.input.resetPosition()}),t("tabindex",null,function(e,t){return e.display.input.getField().tabIndex=t||""}),t("autofocus",null),t("direction","ltr",function(e,t){return e.doc.setDirection(t)},!0)}(bi),function(e){var t=e.optionHandlers,r=e.helpers={}
...
if(i==e||"string"==typeof e&&i.name==e)return r.splice(n,1),t.state.modeGen++,void Cr(t)}}),indentLine:xr(function(e,t,r){"string"!=typeof t&&"number"!=typeof t&&(t=null==t?this.options.smartIndent?"smart":"prev":t?"add":"subtract"),W(this.doc,e)&&wi(this,e,t,r)}),indentSelection:xr(function(e){for(var t=this,r=this.doc.sel.ranges,n=-1,i=0;i<r.length;i++){var o=r[i]
if(o.empty())o.head.line>n&&(wi(t,o.head.line,e,!0),n=o.head.line,i==t.doc.sel.primIndex&&ar(t))
else{var a=o.from(),l=o.to(),s=Math.max(n,a.line)
n=Math.min(t.lastLine(),l.line-(l.ch?0:1))+1
for(var u=s;u<n;++u)wi(t,u,e)
var c=t.doc.sel.ranges
0==a.ch&&r.length==c.length&&c[i].from().ch>0&&fn(t.doc,i,new Zo(a,c[i].to()),fo)}}}),getTokenAt:function(e,t){return Re(this,e,t)},getLineTokens:function(e,t){return Re(this,D(e),t,!0)},getTokenTypeAt:function(e){e=B(this.doc,e)
...
null!=r.scrollTop&&cr(e,r.scrollTop),null!=r.scrollLeft&&fr(e,r.scrollLeft)}(this,{left:l,top:a,right:l+t.offsetWidth,bottom:a+t.offsetHeight})},triggerOnKeyDown:xr(li),triggerOnKeyPress:xr(ui),triggerOnKeyUp:si,triggerOnMouseDown:xr(ci),execCommand:function(e){if(da.hasOwnProperty(e))return da[e].call(null,this)},triggerElectric:xr(function(e){Si(this,e)}),findPosH:function(e,t,r,n){var i=this,o=1
t<0&&(o=-1,t=-t)
for(var a=B(this.doc,e),l=0;l<t&&!(a=Ni(i.doc,a,o,r,n)).hitSide;++l);return a},moveH:xr(function(e,t){var r=this
this.extendSelectionsBy(function(n){return r.display.shift||r.doc.extend||n.empty()?Ni(r.doc,n.head,e,t,r.options.rtlMoveVisually):e<0?n.from():n.to()},po)}),deleteH:xr(function(e,t){var r=this.doc.sel,n=this.doc
r.somethingSelected()?n.replaceSelection("",null,"+delete"):Qn(this,function(r){var i=Ni(n,r.head,e,t,!1)
...
if(null==a?a=u.left:u.left=a,(l=Ai(i,u,o,r)).hitSide)break}return l},moveV:xr(function(e,t){var r=this,n=this.doc,i=[],o=!this.display.shift&&!n.extend&&n.sel.somethingSelected()
...
var s=Ai(r,l,e,t)
return"page"==t&&a==n.sel.primary()&&or(r,Nt(r,s,"div").top-l.top),s},po),i.length)for(var a=0;a<n.sel.ranges.length;a++)n.sel.ranges[a].goalColumn=i[a]}),findWordAt:function(e){var t=L(this.doc,e.line).text,r=e.ch,n=e.ch
...
return t.cm=null,Zr(this,e),kt(this),this.display.input.reset(),lr(this,e.scrollLeft,e.scrollTop),this.curOp.forceScroll=!0,Ye(this,"swapDoc",this,t),t}),getInputField:function(){return this.display.input.getField()},getWrapperElement:function(){return this.display.wrapper},getScrollerElement:function(){return this.display.scroller},getGutterElement:function(){return this.display.gutters}},ye(e),e.registerHelper=function(t,n,i){r.hasOwnProperty(t)||(r[t]=e[t]={_global:[]}),r[t][n]=i},e.registerGlobalHelper=function(t,n,i,o){e.registerHelper(t,n,o),r[t]._global.push({pred:i,val:o})}}(bi)
var Sa="iter insert remove copy getEditor constructor".split(" ")
for(var La in na.prototype)na.prototype.hasOwnProperty(La)&&f(Sa,La)<0&&(bi.prototype[La]=function(e){return function(){return e.apply(this.doc,arguments)}}(na.prototype[La]))
return ye(na),bi.inputStyles={textarea:Ca,contenteditable:ka},bi.defineMode=function(e){bi.defaults.mode||"null"==e||(bi.defaults.mode=e),function(e,t){arguments.length>2&&(t.dependencies=Array.prototype.slice.call(arguments,2)),Ao[e]=t}.apply(this,arguments)},bi.defineMIME=function(e,t){Oo[e]=t},bi.defineMode("null",function(){return{token:function(e){return e.skipToEnd()}}}),bi.defineMIME("text/plain","null"),bi.defineExtension=function(e,t){bi.prototype[e]=t},bi.defineDocExtension=function(e,t){na.prototype[e]=t},bi.fromTextArea=function(e,t){function r(){e.value=s.getValue()}if(t=t?c(t):{},t.value=e.value,!t.tabindex&&e.tabIndex&&(t.tabindex=e.tabIndex),!t.placeholder&&e.placeholder&&(t.placeholder=e.placeholder),null==t.autofocus){var n=a()
t.autofocus=n==e||null!=e.getAttribute("autofocus")&&n==document.body}var i
if(e.form&&(Co(e.form,"submit",r),!t.leaveSubmitMethodAlone)){var o=e.form
i=o.submit
...
var s=bi(function(t){return e.parentNode.insertBefore(t,e.nextSibling)},t)
return s},function(e){e.off=he,e.on=Co,e.wheelEventPixels=Fr,e.Doc=na,e.splitLines=Lo,e.countColumn=d,e.findColumn=h,e.isWordChar=b,e.Pass=co,e.signal=pe,e.Line=Eo,e.changeEnd=Vr,e.scrollbarModel=Uo,e.Pos=D,e.cmpPos=P,e.modes=Ao,e.mimeModes=Oo,e.resolveMode=Me,e.getMode=Ne,e.modeExtensions=Wo,e.extendMode=Ae,e.copyState=Oe,e.startState=ze,e.innerMode=We,e.commands=da,e.keyMap=ca,e.keyName=Yn,e.isModifierKey=_n,e.lookupKey=$n,e.normalizeKeyMap=qn,e.StringStream=zo,e.SharedTextMarker=ta,e.TextMarker=ea,e.LineWidget=Qo,e.e_preventDefault=be,e.e_stopPropagation=we,e.e_stop=ke,e.addClass=l,e.contains=o,e.rmClass=io,e.keyNames=aa}(bi),bi.version="5.31.0",bi}),function(e){"object"==typeof exports&&"object"==typeof module?e(require("../../lib/codemirror")):"function"==typeof define&&define.amd?define(["../../lib/codemirror"],e):e(CodeMirror)}(function(e){"use strict"
...
e.defineMode("javascript",function(t,r){function n(e,t,r){return ye=e,be=r,t}function i(e,t){var r=e.next()
if('"'==r||"'"==r)return t.tokenize=function(e){return function(t,r){var o,a=!1
if(ke&&"@"==t.peek()&&t.match(Ne))return r.tokenize=i,n("jsonld-keyword","meta")
...
if("/"==r)return e.eat("*")?(t.tokenize=o,o(e,t)):e.eat("/")?(e.skipToEnd(),n("comment","comment")):ve(e,t,1)?(function(e){for(var t,r=!1,n=!1;null!=(t=e.next());){if(!r){if("/"==t&&!n)return
...
if(Me.test(r))return">"==r&&t.lexical&&">"==t.lexical.type||(e.eat("=")?"!"!=r&&"="!=r||e.eat("="):/[<>*+\-]/.test(r)&&(e.eat(r),">"==r&&e.eat(r))),n("operator","operator",e.current())
if(Le.test(r)){e.eatWhile(Le)
var l=e.current()
if("."!=t.lastType){if(Te.propertyIsEnumerable(l)){var s=Te[l]
...
if(!(r<0)){if(Se){var n=/:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(e.string.slice(e.start,r))
n&&(r=n.index)}for(var i=0,o=!1,a=r-1;a>=0;--a){var l=e.string.charAt(a),s=Ae.indexOf(l)
if(s>=0&&s<3){if(!i){++a
break}if(0==--i){"("==l&&(o=!0)
...
for(var r=e.context;r;r=r.prev)for(var n=r.vars;n;n=n.next)if(n.name==t)return!0}function c(){for(var e=arguments.length-1;e>=0;e--)We.cc.push(arguments[e])}function d(){return c.apply(null,arguments),!0}function f(e){function t(t){for(var r=t;r;r=r.next)if(r.name==e)return!0
return!1}var n=We.state
if(We.marked="def",n.context){if(t(n.localVars))return
n.localVars={name:e,next:n.localVars}}else{if(t(n.globalVars))return
r.globalVars&&(n.globalVars={name:e,next:n.globalVars})}}function h(){We.state.context={prev:We.state.context,vars:We.state.localVars},We.state.localVars=ze}function p(){We.state.localVars=We.state.context.vars,We.state.context=We.state.context.prev}function g(e,t){var r=function(){var r=We.state,n=r.indented
if("stat"==r.lexical.type)n=r.lexical.indented
else for(var i=r.lexical;i&&")"==i.type&&i.align;i=i.prev)n=i.indented
r.lexical=new s(n,We.stream.column(),e,null,r.lexical,t)}
return r.lex=!0,r}function m(){var e=We.state
e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function v(e){function t(r){return r==e?d():";"==e?c():d(t)}return t}function y(e,t){return"var"==e?d(g("vardef",t.length),U,v(";"),m):"keyword a"==e?d(g("form"),x,y,m):"keyword b"==e?d(g("form"),y,m):"keyword d"==e?We.stream.match(/^\s*$/,!1)?d():d(g("stat"),C,v(";"),m):"debugger"==e?d(v(";")):"{"==e?d(g("}"),I,m):";"==e?d():"if"==e?("else"==We.state.lexical.info&&We.state.cc[We.state.cc.length-1]==m&&We.state.cc.pop()(),d(g("form"),x,y,m,Y)):"function"==e?d(re):"for"==e?d(g("form"),Z,y,m):"variable"==e?Se&&"type"==t?(We.marked="keyword",d(R,v("operator"),R,v(";"))):Se&&"declare"==t?(We.marked="keyword",d(y)):d(g("stat"),O):"switch"==e?d(g("form"),x,v("{"),g("}","switch"),I,m,m):"case"==e?d(b,v(":")):"default"==e?d(v(":")):"catch"==e?d(g("form"),h,v("("),ne,v(")"),y,m,p):"class"==e?d(g("form"),oe,m):"export"==e?d(g("stat"),ue,m):"import"==e?d(g("stat"),de,m):"module"==e?d(g("form"),q,v("{"),g("}"),I,m,m):"async"==e?d(y):"@"==t?d(b,y):c(g("stat"),b,v(";"),m)}function b(e){return k(e,!1)}function w(e){return k(e,!0)}function x(e){return"("!=e?c():d(g(")"),b,v(")"),m)}function k(e,t){if(We.state.fatArrowAt==We.stream.start){var r=t?A:N
if("("==e)return d(h,g(")"),H(ne,")"),m,v("=>"),r,p)
if("variable"==e)return c(h,q,v("=>"),r,p)}var n=t?L:S
return Oe.hasOwnProperty(e)?d(n):"function"==e?d(re,n):"class"==e?d(g("form"),ie,m):"keyword c"==e||"async"==e?d(t?w:b):"("==e?d(g(")"),C,v(")"),m,n):"operator"==e||"spread"==e?d(t?w:b):"["==e?d(g("]"),me,m,n):"{"==e?E(z,"}",null,n):"quasi"==e?c(T,n):"new"==e?d(function(e){return function(t){return"."==t?d(e?function(e,t){if("target"==t)return We.marked="keyword",d(L)}:function(e,t){if("target"==t)return We.marked="keyword",d(S)}):"variable"==t&&Se?d(G,e?L:S):c(e?w:b)}}(t)):d()}function C(e){return e.match(/[;\}\)\],]/)?c():c(b)}function S(e,t){return","==e?d(b):L(e,t,!1)}function L(e,t,r){var n=0==r?S:L,i=0==r?b:w
return"=>"==e?d(h,r?A:N,p):"operator"==e?/\+\+|--/.test(t)||Se&&"!"==t?d(n):"?"==t?d(b,v(":"),i):d(i):"quasi"==e?c(T,n):";"!=e?"("==e?E(w,")","call",n):"."==e?d(W,n):"["==e?d(g("]"),C,v("]"),m,n):Se&&"as"==t?(We.marked="keyword",d(R,n)):"regexp"==e?(We.state.lastType=We.marked="operator",We.stream.backUp(We.stream.pos-We.stream.start-1),d(i)):void 0:void 0}function T(e,t){return"quasi"!=e?c():"${"!=t.slice(t.length-2)?d(T):d(b,M)}function M(e){if("}"==e)return We.marked="string-2",We.state.tokenize=a,d(T)}function N(e){return l(We.stream,We.state),c("{"==e?y:b)}function A(e){return l(We.stream,We.state),c("{"==e?y:w)}function O(e){return":"==e?d(m,y):c(S,v(";"),m)}function W(e){if("variable"==e)return We.marked="property",d()}function z(e,t){if("async"==e)return We.marked="property",d(z)
if("variable"==e||"keyword"==We.style){if(We.marked="property","get"==t||"set"==t)return d(D)
var r
return Se&&We.state.fatArrowAt==We.stream.start&&(r=We.stream.match(/^\s*:\s*/,!1))&&(We.state.fatArrowAt=We.stream.pos+r[0].length),d(P)}return"number"==e||"string"==e?(We.marked=ke?"property":We.style+" property",d(P)):"jsonld-keyword"==e?d(P):"modifier"==e?d(z):"["==e?d(b,v("]"),P):"spread"==e?d(w,P):"*"==t?(We.marked="keyword",d(z)):":"==e?c(P):void 0}function D(e){return"variable"!=e?c(P):(We.marked="property",d(re))}function P(e){return":"==e?d(w):"("==e?c(re):void 0}function H(e,t,r){function n(i,o){if(r?r.indexOf(i)>-1:","==i){var a=We.state.lexical
return"call"==a.info&&(a.pos=(a.pos||0)+1),d(function(r,n){return r==t||n==t?c():c(e)},n)}return i==t||o==t?d():d(v(t))}return function(r,i){return r==t||i==t?d():c(e,n)}}function E(e,t,r){for(var n=3;n<arguments.length;n++)We.cc.push(arguments[n])
return d(g(t,r),H(e,t),m)}function I(e){return"}"==e?d():c(y,I)}function F(e,t){if(Se){if(":"==e)return d(R)
if("?"==t)return d(F)}}function R(e,t){return"variable"==e||"void"==t?"keyof"==t?(We.marked="keyword",d(R)):(We.marked="type",d(K)):"string"==e||"number"==e||"atom"==e?d(K):"["==e?d(g("]"),H(R,"]",","),m,K):"{"==e?d(g("}"),H(j,"}",",;"),m,K):"("==e?d(H(V,")"),B):void 0}function B(e){if("=>"==e)return d(R)}function j(e,t){return"variable"==e||"keyword"==We.style?(We.marked="property",d(j)):"?"==t?d(j):":"==e?d(R):"["==e?d(b,F,v("]"),j):void 0}function V(e){return"variable"==e?d(V):":"==e?d(R):void 0}function K(e,t){return"<"==t?d(g(">"),H(R,">"),m,K):"|"==t||"."==e?d(R):"["==e?d(v("]"),K):"extends"==t?d(R):void 0}function G(e,t){if("<"==t)return d(g(">"),H(R,">"),m,K)}function U(){return c(q,F,_,X)}function q(e,t){return"modifier"==e?d(q):"variable"==e?(f(t),d()):"spread"==e?d(q):"["==e?E(q,"]"):"{"==e?E($,"}"):void 0}function $(e,t){return"variable"!=e||We.stream.match(/^\s*:/,!1)?("variable"==e&&(We.marked="property"),"spread"==e?d(q):"}"==e?c():d(v(":"),q,_)):(f(t),d(_))}function _(e,t){if("="==t)return d(w)}function X(e){if(","==e)return d(U)}function Y(e,t){if("keyword b"==e&&"else"==t)return d(g("form","else"),y,m)}function Z(e){if("("==e)return d(g(")"),Q,v(")"),m)}function Q(e){return"var"==e?d(U,v(";"),ee):";"==e?d(ee):"variable"==e?d(J):c(b,v(";"),ee)}function J(e,t){return"in"==t||"of"==t?(We.marked="keyword",d(b)):d(S,ee)}function ee(e,t){return";"==e?d(te):"in"==t||"of"==t?(We.marked="keyword",d(b)):c(b,v(";"),te)}function te(e){")"!=e&&d(b)}function re(e,t){return"*"==t?(We.marked="keyword",d(re)):"variable"==e?(f(t),d(re)):"("==e?d(h,g(")"),H(ne,")"),m,F,y,p):Se&&"<"==t?d(g(">"),H(R,">"),m,re):void 0}function ne(e,t){return"@"==t&&d(b,ne),"spread"==e||"modifier"==e?d(ne):c(q,F,_)}function ie(e,t){return"variable"==e?oe(e,t):ae(e,t)}function oe(e,t){if("variable"==e)return f(t),d(ae)}function ae(e,t){return"<"==t?d(g(">"),H(R,">"),m,ae):"extends"==t||"implements"==t||Se&&","==e?d(Se?R:b,ae):"{"==e?d(g("}"),le,m):void 0}function le(e,t){return"modifier"==e||"async"==e||"variable"==e&&("static"==t||"get"==t||"set"==t)&&We.stream.match(/^\s+[\w$\xa1-\uffff]/,!1)?(We.marked="keyword",d(le)):"variable"==e||"keyword"==We.style?(We.marked="property",d(Se?se:re,le)):"["==e?d(b,v("]"),Se?se:re,le):"*"==t?(We.marked="keyword",d(le)):";"==e?d(le):"}"==e?d():"@"==t?d(b,le):void 0}function se(e,t){return"?"==t?d(se):":"==e?d(R,_):"="==t?d(w):c(re)}function ue(e,t){return"*"==t?(We.marked="keyword",d(ge,v(";"))):"default"==t?(We.marked="keyword",d(b,v(";"))):"{"==e?d(H(ce,"}"),ge,v(";")):c(y)}function ce(e,t){return"as"==t?(We.marked="keyword",d(v("variable"))):"variable"==e?c(w,ce):void 0}function de(e){return"string"==e?d():c(fe,he,ge)}function fe(e,t){return"{"==e?E(fe,"}"):("variable"==e&&f(t),"*"==t&&(We.marked="keyword"),d(pe))}function he(e){if(","==e)return d(fe,he)}function pe(e,t){if("as"==t)return We.marked="keyword",d(fe)}function ge(e,t){if("from"==t)return We.marked="keyword",d(b)}function me(e){return"]"==e?d():c(H(w,"]"))}function ve(e,t,r){return t.tokenize==i&&/^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)||"quasi"==t.lastType&&/\{\s*$/.test(e.string.slice(0,e.pos-(r||0)))}var ye,be,we=t.indentUnit,xe=r.statementIndent,ke=r.jsonld,Ce=r.json||ke,Se=r.typescript,Le=r.wordCharacters||/[\w$\xa1-\uffff]/,Te=function(){function e(e){return{type:e,style:"keyword"}}var t=e("keyword a"),r=e("keyword b"),n=e("keyword c"),i=e("keyword d"),o=e("operator"),a={type:"atom",style:"atom"},l={if:e("if"),while:t,with:t,else:r,do:r,try:r,finally:r,return:i,break:i,continue:i,new:e("new"),delete:n,void:n,throw:n,debugger:e("debugger"),var:e("var"),const:e("var"),let:e("var"),function:e("function"),catch:e("catch"),for:e("for"),switch:e("switch"),case:e("case"),default:e("default"),in:o,typeof:o,instanceof:o,true:a,false:a,null:a,undefined:a,NaN:a,Infinity:a,this:e("this"),class:e("class"),super:e("atom"),yield:n,export:e("export"),import:e("import"),extends:n,await:n}
if(Se){var s={type:"variable",style:"type"},u={interface:e("class"),implements:n,namespace:n,module:e("module"),enum:e("module"),public:e("modifier"),private:e("modifier"),protected:e("modifier"),abstract:e("modifier"),readonly:e("modifier"),string:s,number:s,boolean:s,any:s}
for(var c in u)l[c]=u[c]}return l}(),Me=/[+\-*&%=<>!?|~^@]/,Ne=/^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/,Ae="([{}])",Oe={atom:!0,number:!0,variable:!0,string:!0,regexp:!0,this:!0,"jsonld-keyword":!0},We={state:null,column:null,marked:null,cc:null},ze={name:"this",next:{name:"arguments"}}
return m.lex=!0,{startState:function(e){var t={tokenize:i,lastType:"sof",cc:[],lexical:new s((e||0)-we,0,"block",!1),localVars:r.localVars,context:r.localVars&&{vars:r.localVars},indented:e||0}
...
return"comment"==ye?r:(t.lastType="operator"!=ye||"++"!=be&&"--"!=be?ye:"incdec",function(e,t,r,n,i){var o=e.cc
for(We.state=e,We.stream=i,We.marked=null,We.cc=o,We.style=t,e.lexical.hasOwnProperty("align")||(e.lexical.align=!0);;)if((o.length?o.pop():Ce?b:y)(r,n)){for(;o.length&&o[o.length-1].lex;)o.pop()()
return We.marked?We.marked:"variable"==r&&u(e,n)?"variable-2":t}}(t,r,ye,be,e))},indent:function(t,n){if(t.tokenize==o)return e.Pass
if(t.tokenize!=i)return 0
var a,l=n&&n.charAt(0),s=t.lexical
if(!/^\s*else\b/.test(n))for(var u=t.cc.length-1;u>=0;--u){var c=t.cc[u]
if(c==m)s=s.prev
else if(c!=Y)break}for(;("stat"==s.type||"form"==s.type)&&("}"==l||(a=t.cc[t.cc.length-1])&&(a==S||a==L)&&!/^[,\.=+\-*:?[\(]/.test(n));)s=s.prev
xe&&")"==s.type&&"stat"==s.prev.type&&(s=s.prev)
var d=s.type,f=l==d
return"vardef"==d?s.indented+("operator"==t.lastType||","==t.lastType?s.info+1:0):"form"==d&&"{"==l?s.indented:"form"==d?s.indented+we:"stat"==d?s.indented+(function(e,t){return"operator"==e.lastType||","==e.lastType||Me.test(t.charAt(0))||/[,.]/.test(t.charAt(0))}(t,n)?xe||we:0):"switch"!=s.info||f||0==r.doubleIndentSwitch?s.align?s.column+(f?0:1):s.indented+(f?0:we):s.indented+(/^(?:case|default)\b/.test(n)?we:2*we)},electricInput:/^\s*(?:case .*?:|default:|\{|\})$/,blockCommentStart:Ce?null:"/*",blockCommentEnd:Ce?null:"*/",blockCommentContinue:Ce?null:" * ",lineComment:Ce?null:"//",fold:"brace",closeBrackets:"()[]{}''\"\"``",helperType:Ce?"json":"javascript",jsonldMode:ke,jsonMode:Ce,expressionAllowed:ve,skipExpression:function(e){var t=e.cc[e.cc.length-1]
