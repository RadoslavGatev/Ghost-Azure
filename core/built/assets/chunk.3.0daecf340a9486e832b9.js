...
if(x.document&&x.document.scripts)for(var u=0;u<x.document.scripts.length;u++)if("true"===x.document.scripts[u].dataset.entry){n=x.document.scripts[u].src
...
//# sourceMappingURL=chunk.3.0daecf340a9486e832b9.map